...
if(typeof ol_fgcolor=='undefined')var ol_fgcolor="#daebee";
if(typeof ol_bgcolor=='undefined')var ol_bgcolor="#637377";
...
var 	isMac=(navigator.userAgent.indexOf("Mac")!=-1),
	olOp=(navigator.userAgent.toLowerCase().indexOf('opera')>-1&&document.createTextNode),
...
function cClick(){
	if(olLoaded){
		runHook("hideObject",FREPLACE,over);o3_showingsticky=0;
	}
	return false;
}
...
function placeLayer(){
	...
	if(o3_frame.innerHeight){
		...
		eval('o3_frame.'+docRoot)&&eval("typeof o3_frame."+docRoot+".clientHeight=='number'")&&eval('o3_frame.'+docRoot+'.clientHeight')){
...
function layerWrite(txt){
	...
	if(olNs4){
		...
		if(olIe5&&isMac)over.innerHTML='';over.innerHTML=txt;
	}else{
