...
if (OpSys == "Linux") {
	...
	{	
		...
		{		alert("Fehler in der Schreibweise der Subnet-Maske!");	    	 	mask.value = "0.0.0.0";
		}    
	}
    ...
    function doMACcheck(object)
    {
      ...
      if ( len == 12 )
      {
        ...
        for ( i = 0; i < len; i++ )
        {
          ...
          if ( doHexCheck(c) < 0 )
          {
          alert("UngÜltige MAC-Adresse");          	object.value ="00:00:00:00:00:00";
            object.focus();
            return;
          }
...
{	d =parseInt(I.value, 10);
	if ( !(d<24 && d>=0) )
	{		alert('Der Wert f&uuml;r Stunde muss zwischen 0 und 23 liegen.');			I.value = I.defaultValue;
	}
}
...
{	d =parseInt(I.value, 10);
	if ( !(d<60 && d>=0) )
	{		alert('Der Wert f&uuml;r Minuten muss zwischen 0 und 59 liegen.');			I.value = I.defaultValue;
	}
}
