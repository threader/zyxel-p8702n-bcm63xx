/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/dslsqa/rel0.6/crosstools-gcc-4.6-linux-3.4-uclibc-0.9.32-binutils-2.21/src/buildroot-2011.11/output/toolchain/gcc-4.6.2/gcc/config/mips/mips.md'.  */
