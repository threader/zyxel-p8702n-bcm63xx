...
#ifdef CONFIG_MSTC_MODIFY // __MSTC__, Richard Huang, For Telefonica 3G WAN backup, __TELEFONICA__, MitraStar Chehuai, 20110616
#define HUAWEI_IOCTL_USB_RESET 0x8000
#endif
