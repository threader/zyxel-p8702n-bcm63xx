...
static unsigned int AUTOMAP_target(struct sk_buff *skb, const struct xt_action_param *par)
...
#ifdef CONFIG_MSTC_MODIFY //__MSTC__, Jeff
...
static int AUTOMAP_checkentry(const struct xt_tgchk_param *par)
{
	return 0;
}
