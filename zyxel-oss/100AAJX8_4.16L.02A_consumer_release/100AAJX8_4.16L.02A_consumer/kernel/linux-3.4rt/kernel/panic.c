...
#define PSI_MYFILE_NAME     "/data/sysCrashLog"
...
/*save crash log to flash*/
int myKerSysFsFileSet(const char *filename, char *buf, int len)
{
    int ret = -1;
    struct file *fp;
    mm_segment_t fs;
...
void panic(const char *fmt, ...)
{
	...
	myKerSysFsFileSet(PSI_MYFILE_NAME, timeBuf, 64);
