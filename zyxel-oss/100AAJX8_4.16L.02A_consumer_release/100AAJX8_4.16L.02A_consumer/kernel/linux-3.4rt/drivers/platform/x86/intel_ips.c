...
#define   TURBO_TMPC4_OVR_EN	(1UL<<31)
#define   TURBO_TMPC4_MASK	(0x000000007fff0000UL)
#define   TURBO_TMPC4_SHIFT	(16)
...
static void ips_cpu_raise(struct ips_driver *ips)
{
	...
	turbo_override |= TURBO_TMPC4_OVR_EN | TURBO_TDP_OVR_EN;
...
static int show_cpu_clamp(struct seq_file *m, void *data)
{
	...
	tdc = (int)((turbo_override & TURBO_TMPC4_MASK) >> TURBO_TMPC4_SHIFT);
