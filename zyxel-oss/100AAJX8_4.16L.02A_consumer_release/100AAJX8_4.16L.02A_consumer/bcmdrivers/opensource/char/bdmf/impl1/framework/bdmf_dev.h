...
struct bdmf_aggr_type
{
    ...
    int need_validation;            /* fields has to be validated when setting attribute.
                                    ...
                                    */
    bdmf_subsystem_t subsystem;     /* Subsystem the aggregate is registered at */
...
struct bdmf_attr
{
    ...
    uint16_t array_size;        /**< Attribute array dimension. Must be set >=1 for attribute arrays */
...
struct bdmf_type
{
    ...
    uint32_t subs_visible;   /**< mask: Subsystems on which the type can be visible */
    uint32_t subs_valid;     /**< mask: Subsystems on which the type registration is valid */
    ...
    */
    ...
    bdmf_subsystem_t subsystem;         /* Subsystem the type is registered at */
    bdmf_remote_handle comm_handle;     /* Communication handle. Used for remote bdmf communication */
    int usecount;
    bdmf_fastlock lock;
