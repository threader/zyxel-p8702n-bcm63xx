...
typedef struct
{
    rdpa_emac_mode group_mode;  /**< Group mode */
    rdpa_emac_mode emac4_mode;  /**< EMAC4 mode */
    rdpa_emac_mode emac5_mode;  /**< EMAC5 mode */
} rdpa_emac_mode_cfg;
...
typedef struct
{
    ...
    rdpa_emac_mode_cfg emac_mode; /**< EMAC working mode */
    int num_wan; /**< Number of WAN interfaces */
    int num_lan; /**< Number of LAN interfaces */
