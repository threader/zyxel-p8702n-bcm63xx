...
#define XTMRT_CMD_SEND_VCHUNT_PATTERN		19
#define XTMRT_CMD_GET_VCHUNT_TEST_STATUS 	20
#define XTMRT_CMD_SET_VCAUTOHUNT_INFO		21
#endif //__MSTC__, Eric, VCAUTOHUNT
#if 1 //__MSTC__, FuChia
#define XTMRT_CMD_GET_TXRATE                22
