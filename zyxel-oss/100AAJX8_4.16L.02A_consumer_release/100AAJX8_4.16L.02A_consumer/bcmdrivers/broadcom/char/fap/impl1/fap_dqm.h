...
#define DQM_FAP2HOST_XTM_RX_Q_LOW         	0
    ...
    #define DQM_FAP2HOST_XTM_RX_DEPTH_LOW   128
#else
...
#ifdef CONFIG_BCM963268
    #define DQM_FAP2HOST_XTM_RX_DEPTH_HI    128
#else
...
/* This is to identify the 14-bit wl_metadata */
#define WLAN_METADATA_IDENTITY	0x8000
...
typedef union {
    struct {
        union {
            struct {
                uint16 reserved2              : 5;
                uint16 recycleFapIdx          : 1;
                uint16 recycleChannel         : 1;
                uint16 recycleType            : 1;
                uint16 offSetSign             : 1;
                uint16 pBufOffset             : 7;
            };
            uint16 half_word1;
        ...
        union {
            struct { /* 43602 metadata */
                uint16 wl_unused1     : 2;
                uint16 wl_metadata    : 14;
            };
            struct { /* 4360 metadata */
                uint16 wl_unused2     : 4; 
                uint16 priority       : 4;
                uint16 wlTxChainIdx   : 8;
            };
            uint16 half_word2;
        };
    };
