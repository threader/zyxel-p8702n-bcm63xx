...
/* IOCTL cmd values 1 and 2 are mapped to FIBMAP and FIGETBSZ on ARM
   ...
   BCM_PLOAM_IOC_INIT                   =    100, /*Return codes: 0*/
...
/*Return codes: 0, EINVAL_PLOAM_GEM_PORT, EINVAL_PLOAM_STATE, EINVAL_PLOAM_ARG*/
#if defined(CONFIG_BCM96816) || defined(CONFIG_BCM96838)
   ...
   BCM_PLOAM_IOC_CFG_DROP_PRECEDENCE,
#endif
} BCM_Ploam_CommandId;
...
#endif
  /* Idintify if accumulation is done in PLOAM or RDPA level */
  IN UINT32 accumulate_stat;
...
typedef enum
{
    ...
    TCONT_SCHD_POLICY_SP,     /* Only applies to 6838 */
    TCONT_SCHD_POLICY_WRR,    /* Only applies to 6838 */
...
/*Multicast filter operations*/
typedef enum {
    BCM_PLOAM_DROP_PRECEDENCE_KEY_OMCI_COLOUR_MARK_NONE = 0,
    BCM_PLOAM_DROP_PRECEDENCE_KEY_OMCI_COLOUR_MARK_INTERNAL,
    BCM_PLOAM_DROP_PRECEDENCE_KEY_OMCI_COLOUR_MARK_DEI,
    BCM_PLOAM_DROP_PRECEDENCE_KEY_OMCI_COLOUR_MARK_PCP8P0D,
    BCM_PLOAM_DROP_PRECEDENCE_KEY_OMCI_COLOUR_MARK_PCP7P1D,
    BCM_PLOAM_DROP_PRECEDENCE_KEY_OMCI_COLOUR_MARK_PCP6P2D,
    BCM_PLOAM_DROP_PRECEDENCE_KEY_OMCI_COLOUR_MARK_PCP5P3D,
    BCM_PLOAM_DROP_PRECEDENCE_KEY_OMCI_COLOUR_MARK_DSCPAF
} BCM_Ploam_MDropPrecedenceKey;

typedef struct {
  IN UINT8 /*   BCM_Ploam_MDropPrecedenceKey */dropPrecedenceKey;
  IN UINT8 direction; /*BCM_PLOAM_DIRECTION_US or BCM_PLOAM_DIRECTION_DS*/
} BCM_Ploam_DropPrecedenceInfo;

typedef struct {
  /* Accepted values: [0..BCM_PLOAM_WRED_NUM_PROFILES-1] */
  INOUT UINT16  ylwyellowMinThreshold;
  INOUT UINT16  ylwyellowMaxThreshold;
   IN UINT8 direction; /*BCM_PLOAM_DIRECTION_US or BCM_PLOAM_DIRECTION_DS*/
   IN UINT8  portId;
   IN UINT8 priority; /*Range: [0..BCM_PLOAM_MAX_PRIORITY]*/
} BCM_Ploam_WREDQInfo;
