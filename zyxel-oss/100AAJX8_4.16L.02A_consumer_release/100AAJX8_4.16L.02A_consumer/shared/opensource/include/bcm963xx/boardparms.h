...
#define BP_AFE_CHIP_RNC                 (6 << 28)
#define BP_AFE_CHIP_GFAST               (7 << 28)
...
#define BP_DDR_TEMP_EXTENDED		(1 << BP_DDR_TEMP_SHIFT)
...
#ifdef CONFIG_MSTC_MODIFY // Mandy,WPS5GLED
...
#ifdef CONFIG_MSTC_MODIFY//__MSTC__, Eason, WLAN_WPS_BTN_SEPARATE
...
#ifdef CONFIG_MSTC_MODIFY // __MSTC__, Paul Ho, Wireless Button
...
#endif
#ifdef CONFIG_MSTC_MODIFY /* LED, __TELEFONICA__, MTSC Curtis, 20111223. */
