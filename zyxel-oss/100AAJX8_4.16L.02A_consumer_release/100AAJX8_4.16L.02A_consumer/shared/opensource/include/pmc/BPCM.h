...
#if defined(_BCM963138_) || defined(CONFIG_BCM963138) || defined(_BCM963148_) || defined(CONFIG_BCM963148) || defined(_BCM963381_) || defined(CONFIG_BCM963381)
typedef union
{
	struct {
#ifdef PMC_LITTLE_ENDIAN
...
#if (defined(_BCM963138_) || defined(CONFIG_BCM963138)) && !(defined(CONFIG_BRCM_CHIP_VER_A0) || defined(IS_REV_A))
typedef union
{
	struct {
#ifdef PMC_LITTLE_ENDIAN
