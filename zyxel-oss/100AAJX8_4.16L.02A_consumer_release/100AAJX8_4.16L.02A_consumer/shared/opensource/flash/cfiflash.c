...
#ifdef MSTC_MODIFY //__MSTC__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
#define ID_MX29LV128DB  0x227A	//jimmy add 2008/11/26
#define ID_MX25L12805DM 0xc218	//jerry add 2009/12/28
#endif
#define ID_AM29LV320M   0x227E
#define ID_AM29LV320MB  0x2200
#define ID_AM29LV320MT  0x2201
#ifdef MSTC_MODIFY //__MSTC__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
#define ID_S29GL256P90  0x2222   //jchang add for spansion 256Mb, the same as MX29GL256E
#endif
...
#define CFI_FLASH_DEVICES                   \
         {{ID_AM29DL800T, "AM29DL800T"},    \
		  ...
		  {ID_MX29LV128DB, "MX29LV128DB"},  /* __MSTC__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11  */ \          
#endif		  
...
#ifdef MSTC_MODIFY //__MSTC__          
		  {ID_S29GL256P90,  "S29GL256P90"}, /* __MSTC__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11  */	\
#endif      		  
          {0, ""}                           \
        }
...
static int cfi_flash_write(unsigned short sector, int offset, unsigned char *buf,
    int nbytes);
#ifdef MSTC_MODIFY //__MSTC__, RaynorChung
#else
...
int cfi_flash_init(flash_device_info_t **flash_info)
{
    ...
    *flash_info = &flash_cfi_dev;
	...
	case ID_I28F640J3:
        ...
        case ID_AM29LV320MT:
#ifdef MSTC_MODIFY //__MSTC__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
        case ID_S29GL256P90	:    			//jchang add
#endif			
        case ID_AM29LV200BT:
        case ID_MX29LV640BT:
#ifdef MSTC_MODIFY //__MSTC__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
        case ID_MX29LV128DB:		//jimmy add 2008/11/26
#endif			
        case ID_M29W640FB:
...
#ifdef MSTC_MODIFY //__MSTC__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
        case ID_MX29LV128DB:		//jimmy add 2008/11/26
        case ID_S29GL256P90:              //jchang add. flat type should work as buttom type
#endif			
        case ID_SST39VF1601:
        case ID_SST39VF3201:
        case ID_SST39VF6401:
...
#ifdef MSTC_MODIFY //__MSTC__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11 
		if(answer == ID_S29GL256P90){	
    		answer = *(fwp + 1);
			if(answer == ID_AM29LV320MT){
				answer = ID_S29GL256P90;
				//printk("\n Detect Spasion 256Mbits"); //jchang debug
			}
		}else{
			answer = *(fwp + 1);
		}
