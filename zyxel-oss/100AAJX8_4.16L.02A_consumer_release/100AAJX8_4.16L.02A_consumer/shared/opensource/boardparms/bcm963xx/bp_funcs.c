...
static bp_pinmux_defs_t g_pinmux_defs_0[] = {
  ...
  { bp_usSpeedLed100, 0, 8, 8 | BP_PINMUX_VAL_4 | BP_PINMUX_HWLED },  // GPHY4 can be on Runner port 0 also
  { bp_usSpeedLed100, 0, 108, 108 | BP_PINMUX_VAL_4 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(8)},  
  { bp_usSpeedLed1000, 0, 9, 9 | BP_PINMUX_VAL_4 | BP_PINMUX_HWLED }, // GPHY4 can be on Runner port 0 also
  ...
  { bp_usGpioUart2Sdin, -1, 27, 22 | BP_PINMUX_VAL_2},
  { bp_usGpioUart2Sdout, -1, 28, 23 | BP_PINMUX_VAL_2},
  ...
  { bp_usLinkLed, 0, 14, 14|BP_PINMUX_VAL_4 | BP_PINMUX_HWLED }, // if GPHY4 on runner port 0
  { bp_usLinkLed, 0, 22, 22|BP_PINMUX_VAL_4 | BP_PINMUX_HWLED }, // RGMII wan act on runner port 0
  { bp_usSpeedLed100, 0, 18, 18|BP_PINMUX_VAL_4 | BP_PINMUX_HWLED }, 
  { bp_usSpeedLed1000, 0, 19, 19|BP_PINMUX_VAL_4 | BP_PINMUX_HWLED }, 
  { bp_usSpeedLed100, 0, 20, 20|BP_PINMUX_VAL_4 | BP_PINMUX_HWLED },  // RGMII wan spd0 on runner port 0
  { bp_usSpeedLed1000, 0, 21, 21|BP_PINMUX_VAL_4 | BP_PINMUX_HWLED }, // RGMII wan spd1 on runner port 0
  ...
  { bp_usSpeedLed100, 0, 26, 26|BP_PINMUX_VAL_4 | BP_PINMUX_HWLED }, // if GPHY4 on runner port 0
  { bp_usSpeedLed1000, 0, 27, 27|BP_PINMUX_VAL_4 | BP_PINMUX_HWLED }, // if GPHY4 on runner port 0
...
#if !defined(_BRCM_CHIP_VER_A0)  && !defined(CONFIG_BRCM_CHIP_VER_A0) /* FIXME -- keeping for 63138A0 support */
...
#ifdef MSTC_MODIFY //__MSTC__, RaynorChung: Ssupport VDSL LED
/**************************************************************************
...
#ifdef MSTC_MODIFY // Mandy WPS5GLED
...
*                  for the board.
***************************************************************************/
int BpGetWlanEnLedGpio( unsigned short *pusValue )
{
    return( BpGetGpio(bp_usGpioWlanEN, pusValue ) );
} /* BpGetDectLedGpio */
...
#ifdef MSTC_MODIFY // __MSTC__, Paul Ho, Wireless Button
    ...
    for (i = 0 ; g_pinmux_defs[i].id  != bp_last ; i++) {
        if ((g_pinmux_defs[i].id == id) && (g_pinmux_defs[i].port == -1) ) {
            if (
                ...
                || (g_pinmux_defs[i].func == -1)) 
               || (( id == bp_ReservedAnyLed)
                && ((BP_PINMUX_OPTLED_VALID | BP_PINMUX_OPTLED_NUM(gpionum)) 
