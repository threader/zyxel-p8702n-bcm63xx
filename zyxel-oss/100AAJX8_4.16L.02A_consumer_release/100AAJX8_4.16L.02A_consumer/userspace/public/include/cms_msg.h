...
typedef enum 
{
   ...
   CMS_MSG_TERMINATE                            = 0x1000080D,  /**< request app to terminate, a response means action has started. */
	...
	CMS_MSG_WL_SETUP_FINISH_MSG						 = 0x10000821, /**< for norway wlan setup finish */
#endif
#ifdef BUILD_MSTC_WLAN_CLIENT_MODE
	   CMS_MSG_WLinSTA_SETUP_FINISH_MSG						= 0x10000822, /**< for norway wlan setup finish */
#endif
   ...
   CMS_MSG_VODSL_IS_READY_FOR_DEINIT            = 0x10002105, /**< query if the voice app is ready to deinit */
	...
	CMS_MSG_REINJECTION_RELAY = 0x10002106,
#endif
   ...
   CMS_MSG_TR69_SESSION_FAIL_LOG                = 0x20000010,  /** TR69 transaction session fail log*/
#endif
#ifdef MSTC_PRIVILEGE_FROMTR69 //__MSTC__, Dennis
   CMS_MSG_PRIVILEGE_MSG                        = 0x20000020,  /**< Sent to dnsproxy to get DNS query error statistic */
#endif
#ifdef MSTC_WAN_8021X_AUTH //__MSTC__, Amy, 802.1x
   CMS_MSG_8021X_STATE_CHANGED                  = 0x20000030,  /**< Sent from wpa_supplicant when wpa supplicant state changes, see also WpaSuppStateMsgBody */
   CMS_MSG_WAN_CONNECTION_DEVICE_LINK_DOWN      = 0x20000031,  /**< request ssk to reset all IP and PPP link status*/
#endif
#ifdef SUPPORT_MSTC_WEB_REDIRECT // __MSTC__, Richard Huang
   CMS_MSG_CHECK_WAN_INFO_RELOAD                = 0x20000040,
#endif
#ifdef MSTC_ROM_D
   CMS_MSG_ROM_D_WRITTEN                        = 0x20000050,  /**< Event sent when a ROM-D is written. */
   CMS_MSG_WRITE_ROMD_FILE                      = 0x20000051,  /**< ask smd to write the ROM-D file. */
#endif
#ifdef MSTC_CERTSELECT //__MSTC__, Dennis, certselect
   CMS_MSG_TR69_CERT_CHANGE                     = 0x20000060,  /** TR69 local certificate change*/
   CMS_MSG_HTTPS_CERT_CHANGE                    = 0x20000061,  /** HTTPS local certificate change*/
#endif //__MSTC__, Dennis, certselect
#ifdef MSTC_VCAUTOHUNT //__MSTC__, Eric, VCAUTOHUNT
   CMS_MSG_VCAUTOHUNT_SEND                      = 0x20000070,
   CMS_MSG_VCAUTOHUNT_STOP                      = 0x20000071,
   CMS_MSG_VCAUTOHUNT_DISP                      = 0x20000072,
   CMS_MSG_VCAUTOHUNT_SAVE_RESULT               = 0x20000073,
   CMS_MSG_VCAUTOHUNT_CONFIG_CHANGED            = 0x20000074,
#endif //MSTC_VCAUTOHUNT
#ifdef MTS_CAPTIVE_PORTAL
   CMS_MSG_CAPTIVE_PORTAL                       = 0x20000080,  /** add a TR69 trusted ca certificate */
#endif
   CMS_MSG_DHCP6S_HOST_INFO                     = 0x20000090,  /* _MSTC_, Leo, Sent from dhcp6s to ssk to inform of lan host stateful addr. */
#ifdef SUPPORT_CONFIGURATION_FILTER
   CMS_MSG_PROC_CONFIG_FILTER                   = 0x200000a0,  /**< ask smd to proc configuration filter. */
   CMS_MSG_GET_CONFIG_FILE_WITH_FILTER          = 0x200000a1,  /**< ask smd for a copy of the config file. */	
#endif
#ifdef SUPPORT_ROMFILE_CONTROL
   CMS_MSG_SAVE_FW_VERSION                      = 0x200000b0,  /**< ask smd for a copy of the config file. */
#endif

#ifdef MSTC_MODIFY

/* __MSTC__, Ailsa, Support nslookup, 20110607*/
   CMS_MSG_NSLOOKUP_STATE_CHANGED               = 0x20000100,   /**< Nslookup state changed (completed, or stopped) */ 
/* __MSTC__, Ailsa, Support nslookup end*/

/* __MSTC__, TengChang Chen, Log, migrate from Common_406 */
   CMS_MSG_SAVE_LOG                             = 0x20000110,  /* Send to syslogd to let it save log to flash */
   CMS_MSG_CLEAR_LOG                            = 0x20000111,  /* Send to syslogd to let it know log is cleared */
   CMS_MSG_LOGFULL_ALARM_SENT                   = 0x20000112,  /* Sent by syslogd to update mdm the log full alarm is sent */
#ifdef MSTC_EMAIL_NOTIFICATION //__MSTC__, TengChang
   CMS_MSG_EMAIL_NOTIFICATION_SEND              = 0x20000113,
#endif //__MSTC__, TengChang
/* __MSTC__, TengChang Chen, Log, migrate from Common_406 end */

/* __MSTC__, Justin, Support TR143 */
   CMS_MSG_CHANG_INFO_APP                       = 0x20000120,  /**< request smd to change an app port  and ip addr*/
   CMS_MSG_WGET                                 = 0x20000121,  /**< request wget to run */
   CMS_MSG_INIT_UDPECHOSKT_INFO                 = 0x20000122,  /**< request smd to configure an app port  and ip addr before open socket*/
   CMS_MSG_DOWNLOAD_DIAG_COMPLETE_EVENT         = 0x20000123,  /**< Download dignostic completed */
/* __MSTC__, Justin, Support TR143 end */

/* Jennifer, support QoS option 61 & option 125 */
   CMS_MSG_QOS_DHCP_OPT61_COMMAND               = 0x20000130, /**< QoS Client ID classification command */
   CMS_MSG_QOS_DHCP_OPT125_COMMAND              = 0x20000131, /**< QoS Vendor specific info classification command */
/* Jennifer, support QoS option 61 & option 125 end */

/* __MSTC__, Jeff */
	CMS_MSG_VLANAUTOHUNT_START		= 0x20000140,
	CMS_MSG_VLANAUTOHUNT_STOP		= 0x20000141,
	CMS_MSG_VLANAUTOHUNT_FINISHED	        = 0x20000142,
	CMS_MSG_VLANAUTOHUNT_HUNTED		= 0x20000143,
	CMS_MSG_VLANAUTOHUNT_TIMEOUT	        = 0x20000144,
/* __MSTC__, Jeff end */
#ifdef BUILD_NORWAY_CUSTOMIZATION
   CMS_MSG_BOOTSLOT_CHANGE			= 0x20000145,
#endif
/* __MSTC__, Dennis */
   CMS_MSG_ACS_CONFIG_CHANGED_WITH_ACSURL       = 0x20000150,  /** ACS URL CHANGE */
/* __MSTC__, Dennis end */

/* __MSTC__, Justin */
   CMS_MSG_IPOX_STATE_CHANGE			= 0x20000160,
/* __MSTC__, Justin end */

/* __MSTC__, Richard Huang */
   CMS_MSG_HOST_NAME_CHANGED                    = 0x20000170,  /**< Sent from httpd to ssk to inform of lan host infomation updating */
   CMS_MSG_UPDATE_STATIC_HOST                   = 0x20000171,  /**< Sent from httpd to dhcpd to inform of static host updating */
   CMS_MSG_RENEW_WAN_CONNSTATUS                 = 0x20000172,  /**< Sent from httpd to ssk to update wan connection status */
/* __MSTC__, Richard Huang end */
#if 1 //_MSTC_,JuWen
//   CMS_MSG_rcl_igdObject = 0x1000318,
//   CMS_MSG_rcl_lanEthIntfObject = 0x1000320,
   CMS_MSG_rcl_vOIPFilterObject = 0x20000173,
   CMS_MSG_rcl_vOIPFilterDomainObject = 0x20000174,
   CMS_MSG_update_WLAN_auto_config = 0x20000175,

#endif
   CMS_MSG_LOAD_IMAGE_fail                      = 0x20000176,  /**once FW upgrade fail, restart APP. */

/* __MSTC__, Amy, Parental Control */
   CMS_MSG_URLFILTER_RELOAD                     = 0x20000180,  /**< Sent to urlfiter to force it reload config file without restart */
/* __MSTC__, Amy, Parental Control end */

/* __MSTC__,Justin */
   CMS_MSG_MCPD_UPDATE                          = 0x20000190,  /**< Sent to mcpd to force it update status without restart */
/* __MSTC__,Justin end*/

/* __MSTC__, Dennis */
   CMS_MSG_CHANG_APP                            = 0x200001a0,  /**< request smd to change an app port */
/* __MSTC__, Dennis end */

/* __MSTC__, Paul Ho, __Qwest__, SinJia, TR069 for wps */
   CMS_MSG_WPS_UPDATE_MSG                       = 0x200001b0,  /**< for wps */
/* __MSTC__, Paul Ho, __Qwest__, SinJia, TR069 for wps end */

#endif

#ifdef DMP_X_5067F0_MSTC_WWAN_1
/* __MSTC__, Richard Huang, For Telefonica 3G WAN backup, __TELEFONICA__, MitraStar Chehuai, 20110617 */
   CMS_MSG_SET_PPP_OPTIONS                      = 0x20000200,  /* Sent to ppp to set ppp options */  
   CMS_MSG_SET_PPP_END                          = 0x20000201,  /* Sent to ppp to end */
/* __MSTC__, Richard Huang, For Telefonica 3G WAN backup, __TELEFONICA__, MitraStar Chehuai, 20110617 end */
/* __MSTC__, Richard Huang, 0x20000210~0x200002FF: reserved for 3G, __TELEFONICA__, MitraStar Chehuai, 20110617 */
   CMS_MSG_3G_CARD_ENABLE                       = 0x20000210,
   CMS_MSG_3G_CARD_DISABLE                      = 0x20000211,
   CMS_MSG_3G_SIM_PIN                           = 0x20000212,
   CMS_MSG_3G_SIM_PUK                           = 0x20000213,
   CMS_MSG_3G_RESET_BUDGET                      = 0x20000214,
   CMS_MSG_3G_PPP_STATE_CHANGE                  = 0x20000215,  /* 3G PPP state change */
   CMS_MSG_3G_PPP_STATE                         = 0x20000216,  /* get 3G ppp dial state */
   CMS_MSG_3G_PPP_STATE_UNCONFIG                = 0x20000217,  /* set 3G Con->connectionStatus UNCONFIGURED */
   CMS_MSG_GET_WAN_CONN_STATUS_EXCLUDE_3GWAN    = 0x20000218,
   CMS_MSG_SET_IPTABLES_BY_CELLD                = 0x20000219, 
   CMS_MSG_ADD_3G_GW                            = 0x2000021a,
   CMS_MSG_DEL_3G_GW                            = 0x2000021b,
   CMS_MSG_SET_CELLD_DEBUG                      = 0x2000021c,
   CMS_MSG_SET_CELLD_NOTICE                     = 0x2000021d,
   CMS_MSG_SET_CELLD_ERROR                      = 0x2000021e,
   CMS_MSG_SET_CELLD_CHECKING_TIME              = 0x2000021f,
   CMS_MSG_CHECK_WWAN_INFO_RELOAD               = 0x20000220,  // The same as CMS_MSG_CHECK_WAN_INFO_RELOAD
   CMS_MSG_WAN_ATM_LINK_UP                      = 0x20000221,
   CMS_MSG_WAN_PTM_LINK_UP                      = 0x20000222,
   CMS_MSG_WAN_ETH_LINK_UP                      = 0x20000223,
/* __MSTC__, Richard Huang, 0x20000210~0x200002FF: reserved for 3G, __TELEFONICA__, MitraStar Chehuai, 20110617 end */
#endif

#ifdef MSTC_MODIFY  //MSTC
   CMS_MSG_CLEAN_MC_LIST                        = 0x20000224,
#endif

#ifdef MSTC_MODIFY	/* MSTC_VOICE */
   CMS_MSG_SHUTDOWN_ZYIMS                       = 0x20000300,  /**< ZyIMS shutdown request. */
   CMS_MSG_START_ZYIMS                          = 0x20000301,  /**< ZyIMS start request. */
   CMS_MSG_ZYIMS_SELF_IP_CHANGE                 = 0x20000302,  /**< ZyIMS self IP has changed. */
   CMS_MSG_ZYIMS_WITHOUT_IP                     = 0x20000303,  /**< ZyIMS bound interface loses IP. */
   CMS_MSG_CLEAR_VOICE_CALLHISTORY              = 0x20000304,
   CMS_MSG_GET_VOICE_OUTGOING_CALLHISTORY       = 0x20000305,
   CMS_MSG_GET_VOICE_INCOMING_CALLHISTORY       = 0x20000306,
   CMS_MSG_GET_VOICE_CALLHISTORY_SUMMARY        = 0x20000307,
   CMS_MSG_GET_VOICE_LINE_STATUS                = 0x20000308,
   CMS_MSG_VOICE_SIP_REGISTER                   = 0x20000309,
   CMS_MSG_VOICE_SIP_DEREGISTER                 = 0x2000030a,
   CMS_MSG_GET_VOICE_LINE_SIP_STATUS            = 0x2000030b,
   CMS_MSG_GET_VOICE_LINE_CALL_STATUS           = 0x2000030c,
   CMS_MSG_VOICE_STOP_REQUEST                   = 0x2000030d,
   CMS_MSG_GET_VOICE_IN_USE_FLAG                = 0x2000030e,
   CMS_MSG_VOICE_CRITICAL_CHANGED               = 0x2000031f,
#ifdef SUPPORT_EMAIL_NOTIFICATION
   CMS_MSG_EMAIL_NOTIFICATION_SEND              = 0x20000320,
#endif
#ifdef SUPPORT_ZYIMSWATCHDOG
   CMS_MSG_ZYIMSWATCHDOG_SET                    = 0x20000330,
#endif
#ifdef MSTC_VOICE_GR909 /*Klose, support GR909*/
   CMS_MSG_VOICE_LINE_TEST                      = 0x20000340,
   /* Fix phone status error in Virtual Device page,__MSTC_VOICE__,Klose,20121106*/
   CMS_MSG_VOICE_PHONE_FLAG                     = 0x20000341,
#endif
#ifdef DMP_X_5067F0_PWRMNGT_1 /*__MSTC__, Leo*/
   CMS_MSG_PHONE_LED_MGMT                       = 0x20000350,
#endif
#endif
   CMS_MSG_GET_SSH_CERT_PWD_CONFIG           = 0x20000360,   /**< Sent from sshd to ssk to ask ssh certificate with password setting */
...
#ifdef MSTC_MODIFY //__MSTC__, Justin
typedef struct
{
...
#ifdef MSTC_MODIFY  /* __MSTC__, Ailsa, Support traceroute, 20110609*/
typedef struct
{
...
#ifdef MSTC_MODIFY /* __MSTC__, Ailsa, Support nslookup , 20110607*/
typedef struct
{
...
#ifdef MSTC_MODIFY //__MSTC__,Lynn,DHCP
...
#ifdef MSTC_MODIFY //__MSTC__,Lynn,DHCP:sync from SinJia, TR-098 DHCP Conditional Serving Pool
   char poolName[CMS_IFNAME_LENGTH]; /** "condservpoolx_brx", vurtual pool name for udhcpd. */
#endif

} DhcpdHostInfoMsgBody;

#ifdef MSTC_MODIFY //__MSTC__,Leo
typedef struct
{
   char ifName[BUFLEN_32];
...
typedef struct
{
  ...
  UBOOL8 isAdd;                   /**< add or delete the address */
  UBOOL8 isIPv4;                  /**< is it a static IPv4 address */
...
#ifdef MSTC_MODIFY //__MSTC__,Lynn,DHCP:sync from SinJia, DHCP Conditional Serving Pool
 ...
 */
typedef struct {
   char  l2Ifname[CMS_IFNAME_LENGTH]; // one LLID is always epon0
   UINT32 linkStatus;
...
#define SET_IPTABLES_CHANNEL_PATH "/var/setIptables.chanl"

#ifdef BUILD_NORWAY_CUSTOMIZATION
#define NUMBEROFIPTABLES 50
#else
#define NUMBEROFIPTABLES 20
#endif
#define IPTABLECMDLENGTH 200
typedef struct
{
   unsigned int numOfCmdInFunction;
   char PutInCmd[NUMBEROFIPTABLES][IPTABLECMDLENGTH];
} Set_iptablesInfo;
typedef struct
{
   _LanEthIntfObject *newObj;
   _LanEthIntfObject *currObj;
   InstanceIdStack iidStack;
} process_info;
#endif
