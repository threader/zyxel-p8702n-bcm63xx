...
#define VAR_LOG_SYSLOGFILE "/var/log/syslog.log" 
#endif

#ifdef BUILD_TMPC2_COMMON_CUSTOMIZATION
#define PHONE_LOG_FILE "/log/phone.log"
#define PHONE_FLASH_LOG_FILE "/data/log/phone"
#endif
...
#ifdef CMS_LOG3
#define cmsLog_error(args...)  log_log((CmsLogLevel)LOG_DEBUG, __FUNCTION__, __LINE__, args)
#define cmsLog_notice(args...) log_log((CmsLogLevel)LOG_NOTICE, __FUNCTION__, __LINE__, args)
