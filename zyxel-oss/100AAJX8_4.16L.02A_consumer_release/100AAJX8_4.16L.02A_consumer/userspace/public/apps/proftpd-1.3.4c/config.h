...
#define PR_BUILD_OPTS " '--prefix=/usr/local' '--sysconfdir=/etc' '--localstatedir=/var/run' '--without-pam' '--disable-auth-pam' '--enable-openssl' '--enable-shadow' '--enable-autoshadow' '--with-modules=mod_sftp'"
...
#define PR_BUILD_LIBS " -lssl -lcrypto -lssl -lcrypto -lcap  -lcrypto -lsupp -lcrypt -ldl  -ldl -lz"
