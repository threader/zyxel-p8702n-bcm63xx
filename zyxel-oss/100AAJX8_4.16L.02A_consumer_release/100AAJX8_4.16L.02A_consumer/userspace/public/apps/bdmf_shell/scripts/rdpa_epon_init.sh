...
# WRR group
#bs /bdmf/new egress_tm/dir=us,index=3,level=egress_tm,mode=wrr

#bs /bdmf/new egress_tm/dir=us,index=31,level=queue,mode=disable,weight=10
#bs /b/c egress_tm/dir=us,index=31 queue_cfg[0]={queue_id=3,weight=0,drop_alg=dt,drop_threshold=256,red_high_threshold=0,red_low_threshold=0}
...
#bs /b/c egress_tm/dir=us,index=3 subsidiary[0]={egress_tm/dir=us,index=31}
#bs /b/c egress_tm/dir=us,index=3 subsidiary[1]={egress_tm/dir=us,index=32}
#bs /b/c egress_tm/dir=us,index=3 subsidiary[2]={egress_tm/dir=us,index=33}
