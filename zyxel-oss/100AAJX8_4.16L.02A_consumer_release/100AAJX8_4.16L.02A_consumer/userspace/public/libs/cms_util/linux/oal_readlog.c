...
#ifdef MSTC_MODIFY //__MSTC__, TengChang Chen, Log, migrate from Common_406
#include <fcntl.h>
#include <stddef.h>
#endif
#include "../oal.h"
...
#ifdef MSTC_MODIFY //__Common__,JhenYang, Uncaught Signal for httpd in Log view security page. And Get Deviceinfo object fail when system log is larger than 32768 byes.
...
/* http://msgsw2.zyxel.com/trac/DSL-491HNU-B1B_Telus/ticket/226 */
  ...
  sem_down(log_semid);
#ifdef MSTC_MODIFY //__MSTC__, TengChang, separate broadcom log, system log, security log in circular buffer
...
#endif
#ifdef BUILD_TMPC2_COMMON_CUSTOMIZATION
nextHead = (struct shbuf_ds *)((char*)secBuf + sysBuf->size + offsetof(struct shbuf_ds, data) + 1);
phoneBuf = nextHead;
#endif
