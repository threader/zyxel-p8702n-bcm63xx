...
#ifdef MSTC_MODIFY //__MSTC__, Dennis, GUI Debug Mode with FTP 
#include <unistd.h>
#endif
...
#ifdef MSTC_MODIFY //__MSTC__, Dennis, Support multi-connections in ftp
...
int main(int argc, char **argv)
{
...

   {
      ...
      if (sock > 0) {
         ...
         cmsUtl_strncpy ( ipAddrBuf, ipAddr, sizeof(ipAddrBuf) );
#endif
