 ...
 *
 ******************************************************************************/
icf_uint8_t iptkapp_trace_send_data_to_screen ( icf_report_trace_ind_st * p_payload)
{
...
icf_uint8_t iptkapp_trace_send_data_to_file (icf_report_trace_ind_st * p_payload)
{
    icf_generic_string_st *p_msg;
    /*
