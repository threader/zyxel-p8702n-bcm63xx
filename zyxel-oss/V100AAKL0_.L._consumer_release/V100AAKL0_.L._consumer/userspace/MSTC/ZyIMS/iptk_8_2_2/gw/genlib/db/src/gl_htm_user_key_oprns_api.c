...
/*****************************************************************************/
{
    ...
    {
        if(((GL_NULL != p_temp_node) && (GL_NULL != p_temp_node->p_next)) || (GL_TRUE == is_first_node))
        {
            /*
            ...
            if((GL_NULL != p_key_select_fn) && (GL_NULL != p_temp_node))
            { 
            ...
            if((GL_HTM_INCLUDE_KEY_IN_RET_LIST == is_key_to_include) && (GL_NULL != p_temp_node))
            {
                /*
