 ...
 ** 05-Jun-09   Anuradha Gupta         SPR 19735       Klocworks Warning Removal
 **
...
#endif
{
	...
	for (index_1 = 0; index_1 < count; index_1 ++)
	{
		...
		{
			/* klocworks warning fixing */
			if(SIP_NULL != clone_string)
			{
...
#endif
{
	...
	{
   /*SPR-19314 fixed*/ 
   /* CSR_1-6567961 Fix Start */
#if 0
	 if((src == SIP_NULL)||(dest==SIP_NULL))
#endif
     if(dest==SIP_NULL)
   /* CSR_1-6567961 Fix End */
	 {
		 *err = E_INV_PARAM;
	     return SipFail;
	 }
...
/*SPR-19314 fixed */
  /* src->pOrigin can be NULL. The code change here is done to prevent 
   * the failure return from function __sip_cloneSdpOrigin
   * if src->pOrigin is NULL.
   */
/* CSR_1-6567961 Change Start */
#if 0
...
#endif
{
	...
	for ( index_1 = 0; index_1 < count ; index_1++)
	{
		...
		{
         /*SPR- 19314 fixed*/
        /* CSR_1-6527624 Change Start */
            sip_listDeleteAll(pDest, pErr );
        /* CSR_1-6527624 Change End */
			return SipFail;
		}
...
#endif
{
    ...
    /* CSR_1-6527624 Change Start */
     { 
        sip_listDeleteAll(&(pDest->slOrderInfo), pErr);
    /* CSR_1-6527624 Change End */
		return SipFail;
    /* CSR_1-6527624 Change Start */
     }
    ...
    {
       sip_listDeleteAll(&(pDest->slOrderInfo), pErr);
       sip_listDeleteAll(&(pDest->slMessageBody), pErr);
    /* CSR_1-6527624 Change End */
	   return SipFail;
    /* CSR_1-6527624 Change Start */
    }
