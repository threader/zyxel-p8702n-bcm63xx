...
/* This error code is set by SSA to indicates that the session expire value
 * provided by application in ICF_SESSION_TIMER_TOGGLE_REQ API is greater than
 * the session expire value in initial request.*/
#define ICF_ECODE_INVALID_SESSION_EXPIRE_VALUE   ICF_CAUSE_INVALID_SESSION_EXPIRE_VALUE    
/* This error code is set by SSA to indicates that the Min-SE value
 * provided by application in ICF_SESSION_TIMER_TOGGLE_REQ API is greater than
 * the Min-SE value in initial request.*/
#define ICF_ECODE_INVALID_MINSE_VALUE            ICF_CAUSE_INVALID_MINSE_VALUE          
