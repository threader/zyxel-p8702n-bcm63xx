 ...
 ** 03-Mar-2002		Aparna				-				Added Auth, From
...
/* klocworks : NULL checks have been added before access to pointer value
 */
...
SipBool sip_formSipParamList
	...
	SipError	*pError)
#else
	(/* CSR_1-6613911 Change Start */pEndBuff, /* CSR_1-6613911 Change End */pOut, list, separator, leadingsep, pError)
	/* CSR_1-6613911 Change Start */
  	SIP_S8bit *pEndBuff;
  	/* CSR_1-6613911 Change End */
	SIP_S8bit *pOut;
...
/* CSR_1-6613911 Change End */
    ...
    {
#ifdef SIP_MSGBUFFER_CHECK
        STR_CAT_SAFE((SIP_S8bit *)pEndBuff,(SIP_S8bit *)pOut, separator);
#else
      /* CSR_1-6613911 Change End */
...
/* CSR_1-6613911 Change End */
...
#ifdef SIP_MSGBUFFER_CHECK 
      STR_CAT_SAFE((SIP_S8bit *)pEndBuff,(SIP_S8bit *) pOut,pParam->pName);
#else
    /* CSR_1-6613911 Change End */
	...
	/* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
            STR_CAT_SAFE((SIP_S8bit *)pEndBuff,(SIP_S8bit *) pOut,value);
#else
          /* CSR_1-6613911 Change End */
...
SipBool sip_formAddrSpec 
	...
	SipError	*pError)
#else
	(/* CSR_1-6613911 Change Start */pDummyBuf,/* CSR_1-6613911 Change End */pOut, pAddrSpec, pError)
	/* CSR_1-6613911 Change Start */
  	SIP_S8bit *pDummyBuf;
  	/* CSR_1-6613911 Change End */
...
#endif
{
/* CSR_1-6613911 Change Start*/	(void) pDummyBuf; /* CSR_1-6613911 Change End*/
    ...
    {
#ifdef SIP_MSGBUFFER_CHECK
        STR_CAT_SAFE((SIP_S8bit *)pDummyBuf,(SIP_S8bit *)pOut, (SIP_S8bit*)"sip:");
#else
        /* CSR_1-6613911 Change End */
    ...
    {
#ifdef SIP_MSGBUFFER_CHECK
        STR_CAT_SAFE((SIP_S8bit *)pDummyBuf, (SIP_S8bit *)pOut, (SIP_S8bit*)"sips:");
#else
        /* CSR_1-6613911 Change End */
...
/* CSR_1-6613911 Change End */
...
#ifdef SIP_MSGBUFFER_CHECK
      STR_CAT_SAFE ((SIP_S8bit *)pDummyBuf,(SIP_S8bit *)pOut, pSipUrl->pUser);
#else
      /* CSR_1-6613911 Change End */
	...
	/* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
        STR_CAT_SAFE((SIP_S8bit *)pDummyBuf, (SIP_S8bit *)pOut, (SIP_S8bit*)":");
			  STR_CAT_SAFE((SIP_S8bit *)pDummyBuf, (SIP_S8bit *)pOut, pSipUrl->pPassword);
#else
      /* CSR_1-6613911 Change Start */
			  (void)STR_CAT ( (SIP_S8bit *)pOut, (SIP_S8bit*)":");
...
/* CSR_1-6613911 Change End */
...
#ifdef SIP_MSGBUFFER_CHECK
    STR_CAT_SAFE((SIP_S8bit *)pDummyBuf, (SIP_S8bit *)pOut, pSipUrl->pHost);
#else
    /* CSR_1-6613911 Change End */
	...
	/* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
        STR_CAT_SAFE((SIP_S8bit *)pDummyBuf, (SIP_S8bit *)pOut, porttext);
#else
      /* CSR_1-6613911 Change End */
      ...
      /* CSR_1-6613911 Change End */
		...
		(void)sip_formSipParamList(/* CSR_1-6613911 Change Start */ pDummyBuf, /* CSR_1-6613911 Change End */pOut, &(pSipUrl->slParam), \
			(SIP_S8bit *)";",1, pError);
	...
	/* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
        STR_CAT_SAFE ((SIP_S8bit *)pDummyBuf, (SIP_S8bit *)pOut, (SIP_S8bit*)"?");
			  STR_CAT_SAFE ((SIP_S8bit *)pDummyBuf, (SIP_S8bit *)pOut, pSipUrl->pHeader);
#else
        /* CSR_1-6613911 Change End */
			(void)STR_CAT ( (SIP_S8bit *)pOut, (SIP_S8bit*)"?");
 	...
 	/* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
    STR_CAT_SAFE ((SIP_S8bit *)pDummyBuf, (SIP_S8bit *)pOut, pAddrSpec->u.pUri);
#else
  /* CSR_1-6613911 Change End */
...
#ifdef ANSI_PROTO
	(/* CSR_1-6613911 Change Start */ SIP_S8bit *pEndBuff, /* CSR_1-6613911 Change End */SIP_S8bit *pOut, SipMessage *pSipMsg, SIP_U32bit dIndex, \
	 en_AdditionMode dMode, en_HeaderForm dForm, en_HeaderType dType, \
	 SipError *pError)
#else
	(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */pOut, pSipMsg, dIndex, dMode, dForm, dType, pError)
	/* CSR_1-6613911 Change Start */
 	 SIP_S8bit 		*pEndBuff;
  	/* CSR_1-6613911 Change End */
	SIP_S8bit 		*pOut;
...
#endif
{
	...
	switch (dType)
	{
		case SipHdrTypeFrom:
			...
			if (SipFail == VALIDATE_HEADER(pHeader, dIndex, pError))
				return SipFail;
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"From: ",\
				(SIP_S8bit*)"f: ");
			break;
		...
		case SipHdrTypeTo:
			...
			if (SipFail == VALIDATE_HEADER(pHeader, dIndex, pError))
				return SipFail;
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"To: ", \
				(SIP_S8bit*)"t: ");
			break;
		...
		case SipHdrTypeRoute:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Route: ", 
				(SIP_S8bit*)"Route: ");
			break;
		...
		case SipHdrTypeRecordRoute:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /*CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Record-Route: ", \
	...
	case SipHdrTypePath:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Path: ", \
				(SIP_S8bit*)"Path: ");
			break;
	case SipHdrTypePAssociatedUri:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"P-Associated-URI: ", \
	...
	case SipHdrTypePCalledPartyId:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"P-Called-Party-ID: ", \
	...
	case SipHdrTypeServiceRoute:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Service-Route: ", \
	...
	case SipHdrTypeHistoryInfo:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"History-Info: ", \
		...
		case SipHdrTypePPreferredId:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, \
	...
	/* CSR_1-6613911 Change Start */
      {
#ifdef SIP_MSGBUFFER_CHECK
        STR_CAT_SAFE((SIP_S8bit *)pEndBuff, (SIP_S8bit *)pOut, pHeader->pBuffer);
#else
        /* CSR_1-6613911 Change End */
	...
	/* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
          STR_CAT_SAFE((SIP_S8bit *)pEndBuff, (SIP_S8bit *)pOut, pHeader->pStr1);
#else
          /* CSR_1-6613911 Change End */
	...
	/* CSR_1-6613911 Change Start */
...
#endif
          /* CSR_1-6613911 Change End */
					(void)sip_formAddrSpec (/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */pOut, pHeader->pAddrSpec, pError);
          /* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
          STR_CAT_SAFE((SIP_S8bit *)pEndBuff, (SIP_S8bit *)pOut, (SIP_S8bit*)">");
#else
          ...
          /* CSR_1-6613911 Change End */
				...
				(void)sip_formSipParamList(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */pOut,&(pHeader->slParam),(SIP_S8bit *)";",1,pError);
...
#endif
{
	...
	switch (dType)
	{
		case SipHdrTypeAuthorization:
		{
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Authorization: ", \
		...
		case SipHdrTypeProxyauthorization:
		{
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Proxy-Authorization: ", \
		...
		case SipHdrTypeProxyAuthenticate:
		{
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Proxy-Authenticate: ", \
		...
		case SipHdrTypeWwwAuthenticate:
		{
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Www-Authenticate: ", \
...
/* CSR_1-6613911 Change Start */
	...
	/* CSR_1-6613911 Change Start */
          ...
          /* CSR_1-6613911 Change End */
				...
				(void)sip_formSipParamList(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */pOut,&(pHeader->slParam),(SIP_S8bit *)",",\
							0,pError);
...
#endif
{
	...
	switch (dType)
	{
		case SipHdrTypeUnsupported:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Unsupported: ", \
		...
		case SipHdrTypeSupported:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Supported: ", \
				(SIP_S8bit*)"k: ");
			break;
		...
		case SipHdrTypeAllow:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Allow: ", \
				(SIP_S8bit*)"Allow: ");
			break;
		...
		case SipHdrTypeAllowEvents:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Allow-Events: ", \
				(SIP_S8bit*)"u: ");
			break;
#endif
		...
		case SipHdrTypeRequire:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Require: ", \
				(SIP_S8bit*)"Require: ");
			break;
		...
		case SipHdrTypeCallId:
			...
			if (SipFail == VALIDATE_HEADER(pHeader, dIndex, pError))
				return SipFail;
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Call-ID: ", \
				(SIP_S8bit*)"i: ");
			break;
		...
		case SipHdrTypeContentEncoding:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Content-Encoding: ", \
				(SIP_S8bit*)"e: ");
			break;
#ifdef SIP_PEMEDIA
...
sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"P-Early-Media: ", (SIP_S8bit*)" P-Early-Media: ");
			break;
#endif
#ifdef SIP_3GPP
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Request-Disposition: ", \
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"SIP-If-Match: ", \
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"SIP-ETag: ", \
				(SIP_S8bit*)"SIP-ETag: ");
			break;
			}
...
#ifdef ANSI_PROTO
	(/* CSR_1-6613911 Change Start */ SIP_S8bit *pEndBuff, /* CSR_1-6613911 Change End */SIP_S8bit *pOut, SdpConnection *pSdpConnection, SipError *pError)
#else
	(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */pOut, pSdpConnection, pError)
	/* CSR_1-6613911 Change Start */
  	SIP_S8bit 		*pEndBuff;
  	/* CSR_1-6613911 Change End */
	SIP_S8bit 		*pOut;
...
#ifdef SIP_MSGBUFFER_CHECK
  STR_CAT_SAFE(pEndBuff, pOut, (SIP_S8bit*)"c=");
	STR_CAT_SAFE(pEndBuff, pOut, pSdpConnection->pNetType);
  STR_CAT_SAFE(pEndBuff, pOut, " ");
	STR_CAT_SAFE(pEndBuff, pOut, pSdpConnection->pAddrType);
  STR_CAT_SAFE(pEndBuff, pOut, " ");
	STR_CAT_SAFE(pEndBuff, pOut, pSdpConnection->pAddr);
...
#ifdef ANSI_PROTO
	(/* CSR_1-6613911 Change Start */ SIP_S8bit *pEndBuff, /* CSR_1-6613911 Change End */SIP_S8bit *pOut, SipList *pslBandwidth, SipError *pError)
#else
	(/* CSR_1-6613911 Change Start */pEndBuff, /* CSR_1-5833143 Change End */pOut, pslBandwidth, pError)
	/* CSR_1-6613911 Change Start */
  	SIP_S8bit 		*pEndBuff;
  	/* CSR_1-6613911 Change End */
	SIP_S8bit 		*pOut;
...
/* CSR_1-6613911 Change End */
    ...
    /* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
    STR_CAT_SAFE (pEndBuff,pOut, (SIP_S8bit*)"b=");
		STR_CAT_SAFE (pEndBuff,pOut, pBandwidth);
		STR_CAT_SAFE (pEndBuff,pOut,(SIP_S8bit*) CRLF);
#else
    /* CSR_1-6613911 Change End */
...
#ifdef ANSI_PROTO
	(/* CSR_1-6613911 Change Start */ SIP_S8bit *pEndBuff, /* CSR_1-6613911 Change End */SIP_S8bit *pOut, SipList *pslAttribList, SipError *pError)
#else
	(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */pOut, pslAttribList, pError)
	/* CSR_1-6613911 Change Start */
 	 SIP_S8bit 	*pEndBuff;
  	/* CSR_1-6613911 Change End */
	SIP_S8bit 	*pOut;
...
#endif
{
    ...
    /* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
    STR_CAT_SAFE(pEndBuff,pOut, (SIP_S8bit*)"a=");
		STR_CAT_SAFE(pEndBuff,pOut, pAttr->pName);
#else
    /* CSR_1-6613911 Change End */
	...
	/* CSR_1-6613911 Change Start */
      ...
      STR_CAT_SAFE(pEndBuff,pOut, (SIP_S8bit*)":");
			STR_CAT_SAFE(pEndBuff,pOut, pAttr->pValue);
#else
      /* CSR_1-6613911 Change End */
...
/* CSR_1-6613911 Change End */)
#else
	(/* CSR_1-6613911 Change Start */pEndBuff,/* CSR_1-6613911 Change End */ppOut, dt, /* CSR_1-6613911 Change Start */pError/* CSR_1-6613911 Change End */)
	SIP_S8bit **ppOut;
	SipDateStruct *dt;
/* CSR_1-6613911 Change Start */
	SipError *pError;
...
/* CSR_1-6613911 Change End */
  (void)pError;	
	...
	if (dt->dDow != SipDayNone)
	{
     /* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
    STR_CAT_SAFE(pEndBuff, out, days[(int)(dt->dDow)]);
		STR_CAT_SAFE(pEndBuff, out,(SIP_S8bit *)", ");
#else
    /* CSR_1-6613911 Change End */
   ...
   /* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
  STR_CAT_SAFE (pEndBuff, out, temp);
	STR_CAT_SAFE(pEndBuff, out, (SIP_S8bit *)" ");
	STR_CAT_SAFE(pEndBuff, out, dMonth[(int)(df->dMonth)]);
	STR_CAT_SAFE(pEndBuff, out,(SIP_S8bit *)" ");
...
#ifdef SIP_MSGBUFFER_CHECK
  STR_CAT_SAFE (pEndBuff,out, temp);
	STR_CAT_SAFE (pEndBuff,out,(SIP_S8bit *)"GMT");
#else
  /* CSR_1-6613911 Change End */
	(void)STR_CAT ( out, temp);
	 ...
	 SipError *pError)
{
	...
	case SipHdrTypePVisitedNetworkId:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"P-Visited-Network-ID: ", \
  ...
  case SipHdrTypePcfAddr:
			...
			if (SipFail == VALIDATE_HEADER(pHeader, dIndex, pError))
				return SipFail;
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"P-Charging-Function-Addresses: ",\
	...
	case SipHdrTypeAcceptContact:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Accept-Contact: ", \
	...
	case SipHdrTypeRejectContact:
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Reject-Contact: ", \
		...
		case SipHdrTypePanInfo:
		{
			...
			if (SipFail == VALIDATE_HEADER(pHeader, dIndex, pError))
				return SipFail;
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"P-Access-Network-Info: ",\
		...
		case SipHdrTypeJoin:
		{
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"Join: ", \
				(SIP_S8bit*)"Join: ");
			break;
		}
		...
		case SipHdrTypePcVector:  
		{
			...
			sip_formHeaderName(/* CSR_1-6613911 Change Start */ pEndBuff, /* CSR_1-6613911 Change End */dMode, dForm, pOut, (SIP_S8bit*)"P-Charging-Vector: ", \
