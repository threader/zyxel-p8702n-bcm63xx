 ...
 *      Rajiv Lumar     12-Dec-2008       SPR 19218            Merged CSR 1-6240518
 *      Preksha         25-May-2009       Rel 8.2              Asynchronus Message Enhancement
 *
...
typedef struct
{
    ...
    */
     ...
     */
     ...
     /* This boolean indicates whether we are waiting for the notify message
        for the subscribe request send for reg event package*/
     icf_boolean_t      await_notify_for_reg_event_pkg;
	/* CSR 1-6240518: Define a new boolean to indicate if trace already sent for 
	 * a message */
	icf_boolean_t	trace_alrdy_sent;     
    /* Asynchronus Message Enhancement : This is the message result to be send to SSA. Success or failure */       
     icf_result_t	    message_result;
} icf_sic_pdb_st;
...
typedef struct
{
   ...
   /* ASYNCHRONUS_MESSAGE enhancements start*/
    icf_sic_fsm_func_ptr_t
	sic_message_fsm_table[ICF_SIC_MAX_MESSAGE_STATES][ICF_SIC_MAX_MESSAGE_EVENTS];
   /* ASYNCHRONUS_MESSAGE enhancements end*/
