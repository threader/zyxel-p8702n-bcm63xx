...
#else
	(/* CSR_1-6613911 Change Start */pEndBuff,/* CSR_1-6613911 Change End */\
...
/* CSR_1-6613911 Change End */
	...
	/* CSR_1-6613911 Change Start */
#ifdef SIP_MSGBUFFER_CHECK
      STR_CAT_SAFE((SIP_S8bit *)pEndBuff, (SIP_S8bit *)pOut, (SIP_S8bit *)pShortname);
#else
      /* CSR_1-6613911 Change End */
    ...
    {
#ifdef SIP_MSGBUFFER_CHECK
      STR_CAT_SAFE((SIP_S8bit *)pEndBuff, (SIP_S8bit *)pOut, (SIP_S8bit *)pFullName);
#else
      /* CSR_1-6613911 Change End */
