 ...
 * 
 *
 * 16-Jan-2008  Kamini Gangwani     Rel 8.0        Function prototype to parse 
 *                                                 P-Called-Party-Id header.
 * 17-Jan-2008  Shruti Thakral                     Enhancements for Rel 8.0
 * 18-Jan-2008  Kamini Gangwani     Rel 8.0        Function prototype to get the transport
 *                                                 protocol from media line. 
 * 25-Jan-2008  Tarun Gupta     IPTK Rel 8.0 LLD   Changes function description.                                                
 ...
 * 18-Jul-2008  Anuradha Gupta     SPR 18803      Modified prototype for function
 ...
 * 21-Nov-2008  Tarun Gupta        SPR 19189      Removed redundant function prototype
 * 21-Nov-2008  Rajiv Kumar        SPR 19188      Rel 7.1.2 SPR merging (SPR
 *                                                18988)  
 * 04-Dec-2008  Rajiv Kumar        SPR 19218      CSR 1-6369301 Merge 
 ...
 * 17-Feb-2009 Anurag Khare        Rel 8.1        SDP TUnnelling enhancements
 * 18-Feb-2009 Abhishek Dhammawat  Rel 8.1        SDP Tunnelling Feature Added
 *                                          icf_ssa_insert_qos_status_lines_in_tunnelled_sdp
 * 02-Mar-2009     Alok Tiwari      IPTK Rel8.1 IPTK open source replacement:
 *                                          parameter changed of function 
 *                                          icf_ssa_dns_start_dns_resp_timer
 *                                          for removing of ares context.
 ...
 * 10-Jun-2009 Kamal Ashraf       SPR 19590     Added icf_ssa_get_msg_body_frm_sip_
 *                                              message_in_call_ctx
 * 21-Jul-2009 Anuradha Gupta     SPR 18906    Added icf_ssa_handle_parse_error prototype
 * 28-Jul-2009 Tarun Gupta        SPR 19886     CSR_1-7155416 merged
 * 02-Aug-2009 Rajiv Kumar        SPR 19886     Merged CSR 1-7444867
 * 04-Aug-2009 Preksha            SPR 19999     Merged CSR 1-7586154
 ...
 * 16-Jun-2010  Rohit Aggarwal	SPR 20428	Changed function prototype
 *
 ...
 *                  the scenario when the challenge algo is AKA.
 *
 ******************************************************************************/
 ...
 *
 * DESCRIPTION:     This function appends the AUTS parameter to Authorization
 *                  header if it is present in case of AKA.
 *
 ******************************************************************************/
 ...
 *
 * DESCRITION:      This function calls the appropriate function for processing
 ...
 ** node of the DNS list will be deleted.The naptr and srv strings are used to
 ** clear respective entries from DNS CLIENT.
 **
 ******************************************************************************/
 ...
 **                    a DNS query. Function will allocate Sdf_st_dnsEvent
 **                    Context and populate it with values from function 
 **                    arguments.
 ...
 *
 * DESCRIPTION:     This function populates the transport protocol from the 
 *                  media m-line.
 * RETURNS:         icf_return_t 
 *                 
 *
...
**              is called from Ares_cbk_uaQueryResults for DNS Success or
**              failure response and icf_ssa_process_timer_expiry in 
...
*               data from the msg whose decode is failed.
*
*
******************************************************************************/
 ...
 ***************************************************************************/
icf_return_t icf_ssa_set_reason_string_in_sip_message(
                                             icf_ssa_pdb_st *p_ssa_pdb,        
                                             SipMessage *pMsg,
                                             SIP_S8bit  *p_reason);

/*Fix Merge For CSR-1-6369301*/
/*****************************************************************************
 ...
 ** 
 ** DESCRIPTION:    This function shall remove qos status lines in the tunnelled sdp
 **                 structure.
 ** RETURN VALUE:   ICF_SUCCESS/ICF_FAILURE
 **
 *****************************************************************************/
 ...
 *                  2. Get the method name from SIP msg
 ...
 *                  FAILURE
 *****************************************************************************/
icf_return_t icf_ssa_compare_request_uri(
                                         icf_ssa_pdb_st  *p_ssa_pdb, 
