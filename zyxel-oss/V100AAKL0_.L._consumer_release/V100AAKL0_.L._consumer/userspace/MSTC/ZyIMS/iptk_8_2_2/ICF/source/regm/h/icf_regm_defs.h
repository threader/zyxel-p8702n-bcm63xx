...
#define ICF_RGM_MAX_STATES        9
#else
#define ICF_RGM_MAX_STATES        7
#endif
...
/* Event to indicate the auth response from application. */
#define ICF_RGM_AUTH_RESP                    18

#ifdef ICF_NAT_RPORT_SUPPORT
#define ICF_RGM_NAT_BINDING_CHNG_IND         19
#endif
