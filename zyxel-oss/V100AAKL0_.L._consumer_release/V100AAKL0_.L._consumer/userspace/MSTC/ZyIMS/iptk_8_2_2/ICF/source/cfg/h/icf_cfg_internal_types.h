 ...
 * 27-Mar-2009  Anuradha Gupta      ICF 8.2     Emergency Call Enhancement
 *
...
ICF_4_0_CRM_END
    ...
    /********************ICF_8.0 Changes****************/
    /* This is the contact URI to be deleted on network initiated 
       deregistration */
    icf_address_st          *p_contact_uri;

    /* This boolean specifies whether porting layer informs IPTK to expect
     * authentication response synchronously or asynchronously. */
    icf_boolean_t           resp_sync_flag;

    /* This field indicates, out of CFG or REGM, which module is sending
     * trigger to CM module for call clear
     */ 
    icf_uint8_t             cm_trigger_module;
