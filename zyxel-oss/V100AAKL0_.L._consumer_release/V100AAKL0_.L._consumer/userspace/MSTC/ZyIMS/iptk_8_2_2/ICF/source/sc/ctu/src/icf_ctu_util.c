...
* 10-Jun-2009   Kamal Ashraf     SPR 19590     Modified icf_ctu_send_ctu_resp 
* 10-Jun-2009   Abhishek Dhammawat SPR 19590   modified
*                                              icf_ctu_clone_app_spec_hdr_list
* 21-Jun-2009   Abhishek Dhammawat SPR 19590   modified
*                                              icf_ctu_clone_app_spec_hdr_list
* 22-Jun-2009   Abhishek Dhammawat SPR 19590   modified icf_ctu_send_ctu_resp
        ...
        INOUT icf_address_st  *p_address)
{
    ...
    if(ICF_SUCCESS == ret_val)
    {
         ...
         * or local user then  return failure*/
    ...
    icf_ctu_pdb_st   *p_ctu_pdb)
{
    ...
    /*SPR 19590 -If any of the header/body/tag lists are present in the
      CTU request then we shall increment the txn id in call ctx
