...
/* klocworks: on function failure legs, freeing the dynamic allocated memory
		...
		(SipError*)&(pError->stkErrCode)))==SipFail)
	{
		...
		if (pError->stkErrCode == Sdf_en_noExistError)
		{
			...
			if ((sdp_setNetTypeInConnection(pConnection, pTmpVal, \
				(SipError*)&(pError->stkErrCode)))==SipFail)
			{
                (void)sdf_memfree(0,(Sdf_ty_pvoid*)&pTmpVal,pError);
				pError->errCode = pError->stkErrCode ;
...
#endif
{
	...
	*ppSdpMessage=Sdf_co_null;
	...
	while (dListIterator.pCurrentElement != Sdf_co_null)
	{
		 ...
		 */
		if ((Sdf_co_null != pMsgBody) && (pMsgBody->dType != SipSdpBody))
		{
			(void)sdf_listNext(&dListIterator, pErr);
			continue;
		}
...
#endif
{
	...
	if(Sdf_co_null == pSessionParam->pMediaStreams)
	{
			...
			switch(dQos)
			{
				case Sdf_en_currQos:
				{
					...
					if(Sdf_mc_strcasecmp(pSplitString1,"e2e")==0)
					{
                        ...
                        /* klocworks: instead of local reference, direct pointer
                         * reference is being passed. this is done as the complete
                         * code leg is in a loop and in case of any error condition
                         * failrue is returned from within the loop. In case of strdup
                         * done to local pointer, klcoworks reports warning that this 
                         * memory will be lost. Therefore , the direct pointers are
                         * passed bypassing any intermediate local references.
                         */    
						/*Direction Type*/
						if(Sdf_mc_strcasecmp(pSplitString1,"send")==0)
						{
							Sdf_mc_strdup(pMediaStream->pCurrentQos->u.pE2eQos->dE2eSend.\
										pPrecondition,"qos");
							
						}else if(Sdf_mc_strcasecmp(pSplitString1,"recv")==0)
						{

							Sdf_mc_strdup(pMediaStream->pCurrentQos->u.pE2eQos->dE2eRecv.\
										pPrecondition,"qos");
					...
					else /* Segmented Qos */
					{
						...
						if(Sdf_mc_strcasecmp(pSplitString1,"local")==0)
						{
							...
							if(Sdf_mc_strcasecmp(pSplitString1,"send")==0)
							{
								Sdf_mc_strdup(pMediaStream->pCurrentQos->u.pSegmentedQos->dLocalSend.\
											pPrecondition,"qos");

							}
							else if(Sdf_mc_strcasecmp(pSplitString1,"recv")==0)
							{
								Sdf_mc_strdup(pMediaStream->pCurrentQos->u.pSegmentedQos->dLocalRecv.\
											pPrecondition,"qos");
						...
						else if (Sdf_mc_strcasecmp(pSplitString1,"remote")==0)
						{
							...
							if(Sdf_mc_strcasecmp(pSplitString1,"send")==0)
							{
								Sdf_mc_strdup(pMediaStream->pCurrentQos->u.pSegmentedQos->dRemoteSend.\
											pPrecondition,"qos");

							}
							else if(Sdf_mc_strcasecmp(pSplitString1,"recv")==0)
							{
								Sdf_mc_strdup(pMediaStream->pCurrentQos->u.pSegmentedQos->dRemoteRecv.\
											pPrecondition,"qos");
				...
				case Sdf_en_desQos:
				{
					...
					if(Sdf_mc_strcasecmp(pSplitString1,"e2e")==0)
					{
						...
						if(Sdf_mc_strcasecmp(pSplitString1,"send")==0)
						{
							Sdf_mc_strdup(pMediaStream->pDesiredQos->u.pE2eQos->dE2eSend.\
										pPrecondition,"qos");
						...
						{
							Sdf_mc_strdup(pMediaStream->pDesiredQos->u.pE2eQos->dE2eRecv.\
										pPrecondition,"qos");
					...
					else /* Segmented */
					{
						...
						if(Sdf_co_null == pMediaStream->pDesiredQos)
                        {	
							if(sdf_ivk_uaInitQosAttrib(\
								&(pMediaStream->pDesiredQos),\
								Sdf_en_segmented,pErr) == Sdf_co_fail)
						...
						if(Sdf_mc_strcasecmp(pSplitString1,"local")==0)
						{
							...
							if(Sdf_mc_strcasecmp(pSplitString1,"send")==0)
							{
								...
								Sdf_mc_strdup(pMediaStream->pDesiredQos->u.pSegmentedQos->dLocalSend.\
										pPrecondition,"qos");
							...
							{
								Sdf_mc_strdup(pMediaStream->pDesiredQos->u.pSegmentedQos->dLocalRecv.\
										pPrecondition,"qos");
										...
										"sendrecv")==0)
							{
								...
								Sdf_mc_strdup( \
		 						pMediaStream->pDesiredQos->u.pSegmentedQos->dLocalRecv.pPrecondition,
								"qos");
								pSegmentQos->dLocalRecv.dQosStrength = \
										dQosStrength;
						...
						else if(Sdf_mc_strcasecmp(pSplitString1,"remote")==0)
						{
							...
							if(Sdf_mc_strcasecmp(pSplitString1,"send")==0)
							{
								Sdf_mc_strdup(pMediaStream->pDesiredQos->u.pSegmentedQos->dRemoteSend.\
										pPrecondition,"qos");
							...
							{
								Sdf_mc_strdup(pMediaStream->pDesiredQos->u.pSegmentedQos->dRemoteRecv.\
										pPrecondition,"qos");
				...
				case Sdf_en_confQos:
				{
					...
					if(Sdf_mc_strcasecmp(pSplitString1,"e2e")==0)
					{
						...
						if(Sdf_mc_strcasecmp(pSplitString1,"send")==0)
						{
							Sdf_mc_strdup(pMediaStream->pConfirmedQos->u.pE2eQos->dE2eSend.\
								pPrecondition,"qos");
							
						}else if(Sdf_mc_strcasecmp(pSplitString1,"recv")==0)
						{
							Sdf_mc_strdup(pMediaStream->pConfirmedQos->u.pE2eQos->dE2eRecv.\
								pPrecondition,"qos");
						}else if(Sdf_mc_strcasecmp(pSplitString1,"sendrecv")==0)
						{
							Sdf_mc_strdup(pMediaStream->pConfirmedQos->u.pE2eQos->dE2eSend.\
					...
					else
					{
                        ...
                        if(Sdf_co_null == pMediaStream->pConfirmedQos)
                        {
							if(sdf_ivk_uaInitQosAttrib(\
								&(pMediaStream->pConfirmedQos),\
										Sdf_en_segmented,\
                       ...
                       /* klocworks: instead of local reference, direct pointer
						...
						if(Sdf_mc_strcasecmp(pSplitString1,"local")==0)
						{
							...
							if(Sdf_mc_strcasecmp(pSplitString1,"send")==0)
							{
								Sdf_mc_strdup(pMediaStream->pConfirmedQos->u.pSegmentedQos->dLocalSend.\
									pPrecondition,"qos");

							}
							else if(Sdf_mc_strcasecmp(pSplitString1,"recv")==0)
							{
								Sdf_mc_strdup(pMediaStream->pConfirmedQos->u.pSegmentedQos->dLocalRecv.\
									pPrecondition,"qos");
						...
						else if (Sdf_mc_strcasecmp(pSplitString1,"remote")==0)
						{
							...
							if(Sdf_mc_strcasecmp(pSplitString1,"send")==0)
							{
								Sdf_mc_strdup(pMediaStream->pConfirmedQos->u.pSegmentedQos->dRemoteSend.\
									pPrecondition,"qos");

							}
							else if(Sdf_mc_strcasecmp(pSplitString1,"recv")==0)
							{
								Sdf_mc_strdup(pMediaStream->pConfirmedQos->u.pSegmentedQos->dRemoteRecv.\
									pPrecondition,"qos");
							}
							else if(Sdf_mc_strcasecmp(pSplitString1,"sendrecv")==0)
							{
...
#endif
{
	...
	if (sdp_setUserInOrigin(pOrigin,pDisplayName, \
		(SipError*)&(pErr->stkErrCode)) == SipFail)
	{
        (void)sdf_memfree (0, (Sdf_ty_pvoid *)&pDisplayName,pErr);
		pErr->errCode = pErr->stkErrCode ;
		sip_freeSdpOrigin(pOrigin);
#ifdef SDF_ERROR			
		sdf_fn_setError(Sdf_en_minorErrors,pErr->errCode,  \
...
{
	Sdf_ty_u32bit	dIndex=0;
  /*CSR_1-6665922 changes starts */
  /* CSR_1-5674509 changes starts */
    ...
    if( (sip_listSizeOf(&(pSdpMedia->slAttr), &dIndex, \
       ...
       /*CSR_1-6665922 changes ends */
  /* CSR_1-5674509 changes ends */
