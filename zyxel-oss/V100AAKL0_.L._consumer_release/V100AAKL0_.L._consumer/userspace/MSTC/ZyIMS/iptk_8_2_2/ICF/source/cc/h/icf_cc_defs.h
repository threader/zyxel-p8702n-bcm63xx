...
/*call_mod_cancel*/
    ...
    ICF_CC_SRTP_FALLBACK_REQ,
/*  REFER/NOTIFY enhancements */
    ICF_CC_PA_GENERIC_MSG_REQ,
    ICF_CC_SSA_GENERIC_MSG_RESP,
    ICF_CC_SSA_GENERIC_MSG_IND,
    ICF_CC_PA_GENERIC_MSG_CFM,
...
/* This hash define define the minimum value of Min-Se header expected in
 * ICF_SESSION_TOGGLE_REQ  API.*/
#define ICF_CC_MIN_SESSION_TIMER_INTERVAL   90
