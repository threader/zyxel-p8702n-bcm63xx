 ...
 * 14-Mar-2009  Abhishek Dhammawat Rel 8.1         Added icf_cc_prep_media_param_for_qos
 * 15-Mar-2009  Anuradha Gupta     Rel 8.1         Added prototypes for Timer Enh
 * 30-Mar-2009  Tarun Gupta        Rel 8.2         Added prototypes for REFER/NOTIFY
 *                                                 Enhancements
 * 31-Mar-2009  Anurag Khare       Rel 8.2         Changes done for PARCK Enh
 * 1-Apr-2009   Abhishek Dhammawat Rel 8.2         Added prototypes for REFER/NOTIFY
 *                                                 Enhancements
 * 07-Dec-2008  Rajiv Kumar        SPR 19428       CSR-1-6767492 Merged
 * 24-Apr-2009  Anuradha Gupta     SPR 19499       Added prototype for MM Err Ind
 * 6-May-2009 Abhishek Dhammawat   SPR 19574       Added icf_cc_16_pa_alert
 * 18-May-2009  Anuradha Gupta     SPR 19672       CSR_1-6347417 Merged
 * 08-Jun-2009 Abhishek Dhammawat  SPR 19590       header overwrite enh 
 ...
 *
 * DESCRIPTION:     This function is invoked when the CC is awaiting 200
 *                  Response from SSA and remote sends response for PRACK
 *                  of 180.
 *                  Current State: ICF_CC_05_AWT_CONNECT
 *                  Current Event: ICF_CC_MEDIA_PARAM_PRACK_RESP
...
/*******************************************************************************
 *
 * FUNCTION:        icf_cc_check_for_srtp_streams
 *
 ...
 *
 * DESCRIPTION:     This function is invoked when the CC is awaiting
 *                  setup resp from SSA and it receives SRTP FALLBACK request from SSA
 *                  Current State: ICF_CC_02_AWT_SSA_SETUP_RESP
...
/*******************************************************************************
 *
 * FUNCTION:        icf_cc_proc_pa_call_term_payload
 *
 * DESCRIPTION:     This function copies additional lists in app term call req
 *		payload into corresponding members of call ctx. This can
 *		be called from any fsm handler that handles term frm app
 *
 ******************************************************************************/
icf_return_t icf_cc_proc_pa_call_term_payload (
        INOUT	icf_cc_pdb_st		*p_cc_pdb);
...
/* New functions for REFER/NOTIFY Enhancements */
...
/******************************************************************************
 *
 * FUNCTION:        icf_cc_proc_generic_msg_cfm_payload
 *
 * DESCRIPTION:     This function copies additional lists in application's
 *                  ICF_GENERIC_MSG_CFM payload into corresponding members
 *                  of call ctx.
 *****************************************************************************/
icf_return_t icf_cc_proc_generic_msg_cfm_payload(
        INOUT  icf_cc_pdb_st *p_cc_pdb);
...
/******************************************************************************
 *
 * FUNCTION:        icf_cc_proc_pa_generic_msg_req_payload
 *
 * DESCRIPTION:     This function copies additional lists in application's
 *                  ICF_GENERIC_MSG_REQ payload into corresponding members
 *                  of call ctx.
 *****************************************************************************/
icf_return_t icf_cc_proc_pa_generic_msg_req_payload (
  INOUT icf_cc_pdb_st           *p_cc_pdb);
 ...
 *
 * DESCRIPTION:     This function handles a DMS Indication from media manger 
 *                  received from the application. 
 *****************************************************************************/
