...
#ifndef __ICF_UNPACK_MM_API__H__
#define __ICF_UNPACK_MM_API__H__
...
icf_uint32_t
icf_unpack_icf_codec_commit_st
(
    icf_uint8_t    *p_dest,
    icf_uint8_t    *p_src,
    icf_uint32_t   *p_length
...
icf_uint32_t
icf_unpack_icf_codec_commit_list_st
(
    icf_list_st    **p_p_icf_codec_commit_list_st,
    icf_uint8_t    *p_src,
    icf_uint32_t   *p_length
);
...
#endif  /* ICF_MM_CFG_FUTURE_RELEASE */
