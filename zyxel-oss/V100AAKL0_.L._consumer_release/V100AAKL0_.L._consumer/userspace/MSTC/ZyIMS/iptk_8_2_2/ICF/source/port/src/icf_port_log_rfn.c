...
*  FUNCTION NAME  :   icf_port_log_rfn_error
...
icf_void_t icf_port_log_rfn_error(
...
*  FUNCTION NAME  :   icf_port_log_rfn_trace
...
icf_void_t icf_port_log_rfn_trace(
