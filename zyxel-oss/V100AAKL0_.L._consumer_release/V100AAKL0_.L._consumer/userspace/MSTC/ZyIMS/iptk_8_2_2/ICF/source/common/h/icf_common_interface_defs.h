...
#define ICF_SA_PRECONDITION_FAILURE     43
...
/*  SPR 18064 Merge */
#define ICF_REGM_SSA_AUTH_PARAM_NOT_RCVD       9
...
#define ICF_STATUS_LINE_NOT_CONFIGURED        2
     ...
     */
#define ICF_CFG_CC_MUTE_OPTION_INVITE_MEDIA_C_ZERO    ICF_CALL_HOLD_OPT_INV_WTH_C_0
#define ICF_CFG_CC_MUTE_OPTION_INVITE_MODE_SEND_ONLY  ICF_CALL_HOLD_OPT_INV_WTH_MODE_SEND_ONLY
#define ICF_CFG_CC_MUTE_OPTION_UPDATE_MEDIA_C_ZERO    ICF_CALL_HOLD_OPT_UPDT_WTH_C_0
#define ICF_CFG_CC_MUTE_OPTION_UPDATE_MODE_SEND_ONLY  ICF_CALL_HOLD_OPT_UPDT_WTH_MODE_SEND_ONLY
#define ICF_CFG_CC_HOLD_OPTION_INV_WTH_MODE_SEND_ONLY_N_MEDIA_C_0  ICF_CALL_HOLD_OPT_INV_WTH_MODE_SEND_ONLY_N_C_0 

/* UPDATE with mode=send only and c=0 */
#define ICF_CFG_CC_HOLD_OPTION_UPD_WTH_MODE_SEND_ONLY_N_MEDIA_C_0  ICF_CALL_HOLD_OPT_UPDT_WTH_MODE_SEND_ONLY_N_C_0

/*CSR_1-7009929 Fixed*/
#define ICF_CFG_CC_HOLD_OPT_INV_WTH_MODE_INACTIVE     ICF_CALL_HOLD_OPT_INV_WTH_MODE_INACTIVE 
#define ICF_CFG_CC_HOLD_OPT_UPDT_WTH_MODE_INACTIVE    ICF_CALL_HOLD_OPT_UPDT_WTH_MODE_INACTIVE
#define ICF_CFG_CC_HOLD_OPT_INV_WTH_MODE_SEND_ONLY_N_SESSION_C_0   ICF_CALL_HOLD_OPT_INV_WTH_MODE_SEND_ONLY_N_SESSION_C_0
#define ICF_CFG_CC_HOLD_OPT_UPDT_WTH_MODE_SEND_ONLY_N_SESSION_C_0  ICF_CALL_HOLD_OPT_UPDT_WTH_MODE_SEND_ONLY_N_SESSION_C_0
#define ICF_CFG_CC_HOLD_OPT_INV_WTH_MODE_INACTIVE_N_SESSION_C_0    ICF_CALL_HOLD_OPT_INV_WTH_MODE_INACTIVE_N_SESSION_C_0 
#define ICF_CFG_CC_HOLD_OPT_UPDT_WTH_MODE_INACTIVE_N_SESSION_C_0   ICF_CALL_HOLD_OPT_UPDT_WTH_MODE_INACTIVE_N_SESSION_C_0
