 ...
 **                                         tunnelled mode. 
 ** 22/04/09    Rajiv Kumar Rel8.2          RFC 4320 Implementation added.  
 ** 06/10/09    Preksha     Rel8.2          SPR 20108
 ** 29/05/10    Alok Tiwari  SPR-20412      Merged CSR 1-8196703
 **
 ******************************************************************************
 ...
 * Retransmission elements
 */
#define Sdf_co_numTxnHashMaxElements	100
...
/*SPR 20412:CSR 1-8196703 merged.*/
/*Size of Sdf_co_characterBufferSize should be equal to
 *ICF_MAX_STR_LEN defined in icf_defs.h*/
...
/* CSR 1-7522910 Change Start*/
   Sdf_en_txnInvMessage                =  (Sdf_error_base +24),
   Sdf_en_txnNoExist                   =  (Sdf_error_base +25),
   Sdf_en_txnInvState                  =  (Sdf_error_base +26),
   Sdf_en_txnExists                    =  (Sdf_error_base +27),
   Sdf_en_invRange                     =  (Sdf_error_base +28),
   Sdf_en_NetworkSentFailure           =  (Sdf_error_base +29),
   Sdf_en_bufOverflow                  =  (Sdf_error_base +30),
/* CSR 1-7522910 Change End*/
...
/* CSR 1-7690605: SPR 20108 */
    Sdf_en_notImplemented               =  (Sdf_en_LastCoreStackErrors+2),
    Sdf_en_sendFailed                   =  (Sdf_en_LastCoreStackErrors+3),
    Sdf_en_timeOut                      =  (Sdf_en_LastCoreStackErrors+4),
    Sdf_en_hashFail                     =  (Sdf_en_LastCoreStackErrors+5),
    Sdf_en_recvFail                     =  (Sdf_en_LastCoreStackErrors+6),
	Sdf_en_LastIncompMsgErr				=  (Sdf_en_LastCoreStackErrors+7),
  ...
  Sdf_en_lowSessionTimerIntervalError = (Sdf_en_LastUATKAccessError+20),
    ...
    Sdf_en_responseForNITNotAllowed		=   (Sdf_en_LastCallStateError+9),	
