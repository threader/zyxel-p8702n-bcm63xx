...
** 27/02/2009 Rajiv Kumar       SPR:20169   Merged CSR-1-7813536
**
...
#endif
{
	...
	if(HSS_CHECKREF(pOrderInfo->dRefCount))
	{
		...
		HSS_FREE(pOrderInfo);
        /*Fix for CSR-1-7813536 Start*/
        pOrderInfo = SIP_NULL;
        /*Fix for CSR-1-7813536 End*/
	}
	else
	{
		HSS_UNLOCKREF(pOrderInfo->dRefCount);
...
/*CSR 1-6466704 CSR Change Start*/
