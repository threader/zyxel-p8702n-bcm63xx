...
** 29/01/2009   Kamal Ashraf    IPTK Rel 8.1    Prototype added for API
**                                              sip_getTypeFromContactHdr 
**                                              sdp_getSdpOriginAsString
...
**
************************************************************************/
extern SipBool sip_insertMultipleHeadersFromStringAtIndex _ARGS_ ((SipMessage *msg, \
		en_HeaderType type, SIP_S8bit *hdr, SIP_U32bit index, SipError *err));

/*Prototype added for IPTK Rel 8.1(UATK Enhancement)*/
