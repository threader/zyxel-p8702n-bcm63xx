 ...
 *                                          for timer expiries
 * 24-Jan-2008   Tarun Gupta    IPTK Rel 8.0 LLD      Added function
 *                                                    prototypes for AKA
 *                                                    handling.
 * 11-Mar-2008   Divij Agarwal      SPR 18122         Support for async 
 *                                                    AKA negotiation
 ...
 * 02-Mar-2009   Kamal Ashraf       IPTK REL 8.1      prototype added for
 *                                                    icf_port_init_dns_client and
 *                                                    icf_port_create_dns_client_thread
 * 13-Mar-2009   Rajiv Kumar        IPTK Rel8.1       Changes done for Merging
 *                                                    CSR-1-6452321
 ...
 * 20 Aug 2009   Anuradha Gupta     SPR 19935      Added Snprintf for VxWorks 
...
#if defined(ICF_PORT_LINUX)|| defined(ICF_PORT_WINDOWS)
#include <string.h>
#endif
/******************** USER INCLUDE FILES *********************************/
 ...
 ** DESCRIPTION:  following is used for freeingsecure data context allocated
 **               when TLS server was opened.
 ***************************************************************************/
icf_void_t icf_port_free_secure_data_ctx(
            icf_void_t               *p_secure_data);
#endif
/***************************************************************************
 ...
 *
 * DESCRIPTION:     This function will actualy send the dhcp message
 *                  
 *
 *
 * RETURNS:         ICF_SUCCESS if successfully parse otherwise ICF_FAILURE
...
*
*  RETURN         :  This will return the number of bytes read
*************************************************************************/
...
***************************************************************************/
icf_boolean_t icf_port_is_valid_domain_name_char(
                                icf_uint8_t num);
...
#ifdef ICF_PORT_VXWORKS
/* Date parameter added to set the date information 
 * on vxWorks. This is required in case of TLS transport
 */
#ifdef ICF_SECURE_SUPPORT
...
*
 ******************************************************************************/
icf_boolean_t   icf_port_init_dns_client(
