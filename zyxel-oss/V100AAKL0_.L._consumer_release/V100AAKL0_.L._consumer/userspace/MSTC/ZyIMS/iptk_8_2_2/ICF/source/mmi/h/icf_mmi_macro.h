 ...
 *          Tarun Gupta          08-Apr-2008        SPR 18355
 *			Saurabh Gupta        17-Mar-2009        SPR 19349
 *          
...
{\
    if ((ICF_NULL != (p_mmi_pdb)) && (ICF_NULL!= (p_mmi_pdb)->p_mmi_ctx))p_mmi_pdb->p_mmi_ctx->mmi_state = state;\
}  
