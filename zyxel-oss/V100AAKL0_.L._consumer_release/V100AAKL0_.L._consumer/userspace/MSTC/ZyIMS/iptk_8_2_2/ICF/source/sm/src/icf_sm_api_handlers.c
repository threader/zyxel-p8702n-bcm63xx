 ...
 * 04-Jun-2008  Tarun Gupta     SPR 18585      Controlling debug trace prinitng 
 *                                             through API ICF_SET_TARCE_REQ
        ...
        INOUT   icf_sm_pdb_st *p_sm_pdb)
{
    ...
    */
        ...
        {/* The recd. trace_details are valid.processing begins */
            ...
            if(ICF_TRACE_DEBUG_TRACE_STATUS_PRESENT & p_recd_msg_payload->bitmask)
            {
	          p_glb_pdb->trace_info.status = p_recd_msg_payload->debug_trace_status;
            }
