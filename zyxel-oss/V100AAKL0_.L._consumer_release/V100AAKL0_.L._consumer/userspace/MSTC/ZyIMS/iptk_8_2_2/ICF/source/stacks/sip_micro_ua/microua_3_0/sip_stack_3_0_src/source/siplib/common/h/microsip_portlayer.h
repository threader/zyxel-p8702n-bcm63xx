...
** 12-Jun-2009  Anuradha Gupta   SPR 19737    strncat prototype added
**
...
extern SIP_S8bit* sip_strncat(SIP_S8bit *pDest,SIP_S8bit *pSrc,SIP_U32bit dSize);
...
#if defined(ICF_STACK_PORT) && defined(ICF_PORT_WINCE)
/*******************************************************************************
