...
*   27-May-2008  Tarun Gupta     SPR 18585      Modified icf_twc_01_mm_err_ind and
        ...
        INOUT   icf_twc_pdb_st *p_pdb)
{
    ...
    {
        /* do nothing as configuration data is not available
         */ 
    }    
    else if(ICF_TRUE == p_config_data->conf_fail_call_clear_not_reqd)
	{
