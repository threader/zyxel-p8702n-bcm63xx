 ...
 *                                          support in Rel 8.0
 *
 * 15-Jan-2008  Neha Gupta      SPR 18033   Added support function failure
 *					    simulation for UT.
 * 15-Jan-2008  Rajiv Kumar     ICF 8.0     Registration Procedure
 *                                          Enhancements  
 *
 * 16-Jan-2008  Kamini Gangwani Rel 8.0     Added a new field in icf_config_data_st to get access 
 *                                          network info at runtime .
 * 17-Jan-2008  Abhishek Dhammawat Rel8.0   Added bitmask for precondition in 
 *                                          call context structure.
 * 17-Jan-2008  Abhishek Dhammawat Rel8.0   Added field precondition_required
 *                                          in icf_config_data_st   
 * 18-Jan-2008  Kamini Gangwani Rel 8.0     Added media_transport_type in config data as well 
 *                                          as call context.
 * 24-Jan-2008  Tarun Gupta    IPTK Rel 8.0 LLD  Added a new data type 
 * 24-Mar-2008  Tarun Gupta    IPTK Rel 8.0 Merged User Param and
 *                                          Dynamic Payload Enhancements
 * 12-Apr-2008  Alok Tiwari    KW IPTK-8.0  The new structure and some fields
 *                                          added to filter the klocwork 
 *                                          warnings of type FALSE POSITIVE     
 ...
 * 17-May-2008  Amit Sharma    SPR:18577    Defining line_id, rgm_ctx and sic_ctx
 *                                          in icf_glb_pdb_st 
 ...
 * 04-Jun-2008  Tarun Gupta    SPR 18585    Merged changes for CSR 1-5905629
 * 06-Jun-2008  Tarun Gupta    SPR 18585    New bitmask for remote resume added
 * 07-Jun-2008  Amit Sharma       IPTK 8.0 SRTP LLD      SRTP Enhancements
 * 13-Jun-2008  Tarun Gupta    SPR 18585    Modified icf_line_data_st and icf_config_data_st
 * 25-Jun-2008 Abhishek Dhammawat IPTK Rel8.0 Modified icf_line_data_st
 * 26-Jun-2008  Amit Sharma    SPR:18725    Defining warning_header_code in
 *                                          icf_call_ctx_st
 ...
 * 12-Feb-2009  Anurag Khare   ICF Rel 8.1  Call modify Enhancements
 * 16-Feb-2009  Anurag Khare   ICF Rel 8.1  Forking related call modify 
 *                                          enhancements
 * 18-Feb-2009 Abhishek Dhammawat Rel 8.1   Added offer_received field in
 *                                          call context.
 * 27-Feb-2009 Preksha         Rel 8.1      Added func_level and func_visited
 *                                          field in icf_func_fail_info_st.
 * 02-Mar-2009 Kamal Ashraf    Rel 8.1      structure variables added in
 *                                          icf_config_data_st structure for
 *                                          open source replacement  
 * 14-Mar-2009 Abhishek Dhammawat Rel 8.1   Added inv_failure_handling_reqd 
 *                                          field in call ctx.
 * 27-Mar-2009  Anuradha Gupta    Rel 8.2   Emergency Call Enhancement            
 * 27-Mar-2009  Ashutosh Mohan    Rel 8.2   Modified icf_call_ctx_st
 *
 *                                          field in call ctx. 
 * 30-Mar-2009 Anurag Khare       Rel 8.2   fields added in call ctxt for
 *                                          PRACK Enhancements feature
 * 30-Mar-2009 Tarun Gupta     Rel 8.2      Refer/Notify Enhancements
 * 29-Apr-2009 Abhishek Dhammawat SPR 19491 Modified call ctx with addition
 *                                          of call_modify_req_ongoing
 * 6-May-2009 Abhishek Dhammawat SPR 19574  Modified call ctx with addition
 *                                          of media_connect_sent
 * 18-May-2009  Anuradha Gupta   SPR 19672  modified icf_config_data_st
 * 21-May-2009  Anuradha Gupta   SPR 19672  Merged CSR 1-6580995
 * 25-May-2009  Rajiv Kumar      SPR 19666  New field added for 302 response.
 ...
 * 06-Jun-2009  Abhishek Dhammawat SPR19590 Header overwrite enh
 * 27-Jul-2009  Tarun Gupta      SPR 19886  Merged CSR 1-7009954
 * 03-Aug-2009  Tarun Gupta      SPR 19886  Merged CSR 1-7334184
 * 19-Aug-2009 Abhishek Dhammawat SPR 19941 Modified call ctx with addition
 *                                          of detach_cc_from_line
 * 11-Sep-2009  Rajiv Kumar       SPR 19999 Merged CSR 1-7547597
 * 15-Sep-2009  Anuradha Gupta   SPR 19999  Merged CSR 1_7618644
 * 08-Oct-2009 Abhishek Dhammawat SPR 20063 Modified call ctx with addition
 *                                          of redirect_trans_mode
 * 08-Oct-2009 Abhishek Dhammawat SPR 20063 Merged CSR 1-7407479 
 * 10-Oct-2010 Rajiv Kumar        SPR 20101 Fix for SPR: 20101
 * 09-Jul-2010 Udit Gattani       SPR 20517 A new parameter is_sdp_received
 *       
 * 11-Oct-2010 Sachin Sharma     SPR 20697  Fix CSR 1-9012191                                    added in icf_call_ctx_st
 * 25-Jan-2013 Pratishtha Pandey SPR Bug273 Fix for CSR 00024478
 *
...
typedef icf_uint8_t         icf_mmi_event_t;
...
/*------------------------------------------------------------------------------
 *
 * Type Name   :  icf_dhcp_resp_st
 * Description :  This structures stores the response of DHCP Server
 *                for options 6(DNS Server Addresses)
 *                and 120 (SIP Server Addresses)
 *
 *----------------------------------------------------------------------------*/

typedef struct
{
    /*  This defines number of maximum SIP or DNS server addresses copied
        from DHCP response  */
    #define ICF_MAX_SERVERS_FROM_DHCP_RESP 2

    /*  This field will store top two SIP server addresses from list of SIP
    servers received in DHCP response  */

    icf_string_st       proxy_list[ICF_MAX_SERVERS_FROM_DHCP_RESP];

/*  This feature is out of scope now */
#if 0
    /*  This field will store top two DNS server addresses from list of DNS
    servers received in DHCP response  */

    icf_string_st       dns_server_addr[ICF_MAX_SERVERS_FROM_DHCP_RESP];
#endif
} icf_dhcp_resp_st;
...
ICF_4_0_CRM_END
	...
	icf_transport_address_st	*p_dns_server_addr;

	/* Secondary DNS Server address */
	icf_transport_address_st	*p_sec_dns_server_addr;

	/* This flag shall be TRUE if secondary DNS Server is active */
	icf_boolean_t				sec_dns_server_active;

	/* This flag shall be TRUE if secondary proxy server is active */
	icf_boolean_t				sec_proxy_server_active;
...
*/
    ...
    /*  CSR 1-6178201: SPR 18822: Change the data type from uint 8 to uint 
	 *  16 bit */
...
#define                ICF_DNS_PORT_CONFIGURED_BY_APP      0x01
   ...
   /* Number of maximum active calls that can be simultaneously
    * on a line. */
   icf_uint8_t                   max_active_calls_per_line;  

    /********************ICF_8.0 Changes****************/
    /*This field indicates whether the subscription for reg event package is
      required after successful registration.*/  
    icf_boolean_t                 reg_event_pkg_support_reqd;
    /*This field indicates if any registration request has been triggered by
      application.*/
    icf_boolean_t                 is_reg_triggered;
 
/*Start: Rel8.0 Added for precondition support */
#ifdef ICF_QOS_SUPPORT
   /* This boolean will be used for identifying the QOS precondition
      is required or not */
   icf_boolean_t                 precondition_required;
#endif
/*End: Rel8.0 Added for precondition support */

/* This will store DHCP server address received from application*/
   icf_transport_address_st*    p_dhcp_server_addr;

/* This will store DHCP client port received from application. If
   application has not configured DHCP client port then this field will be
   populated from ICF_DHCP_CLIENT_PORT  */
   icf_uint16_t                 dhcp_client_port;

/* This will store DHCP response timer received from application. If
   application has not configured this timer then this field will be
   populated from ICF_DHCP_RESP_TIMER. This timer will be
   in milli-seconds. */
   icf_duration_t                       dhcp_response_timer;

/* This will store DHCP response received from DHCP server. This field will
   be NULL in case of no DHCP query or DHCP failure response. */
   icf_dhcp_resp_st*                    p_dhcp_resp;

   /*To get the access network information at runtime*/
    icf_string_st                *p_access_network_info; 

   icf_media_transport_mode_et           media_transport_type;
   /* This boolean has been added to support SRTP Fallback in IPTK*/
   icf_boolean_t                  srtp_fallback_reqd;
 
   /* This list will contain the error response codes configured by the
      application to perform SRTP Fallback mechanism in IPTK*/
   ...
   /* This indicates that the application wants early session indication
      for incoming INVITE and out of dialog OPTIONS requests. This field is 
      set according to the field early_incoming_session_ind_reqd of the 
      API ICF_SET_CALL_PARAMS_REQ. By default, its value is set to ICF_FALSE.
   */
...
#endif
   /* New boolean added for ASYNCHRONUS_MESSAGE enhancements*/
   /* Boolean field to determine that asynchronous incoming MESSAGE support is on*/
   icf_boolean_t async_message_support_reqd;


   /* The following field indicates if true,IPTK will retry if the 
    * 491 response is received from network of auto
    * reinvite/update.
    */
   icf_boolean_t                 retry_codec_commit_req;

   /* SPR-19321 -A new Boolean named update_for_offeranswer_after_
	connect added in this structure that will indicate whether reinvite 
    for codec committed should go or not in case codec negotiation takes
	place through a reinvite. If it is 1 then upadte_for_offeranswer_
	after_connect is enabled.  if it 0 then it  means it is disabled.
    By Default this boolean will be FALSE  i.e. session timer feature 
	will be disabled.*/      
   ...
   /* This parameter indicates whether IPTK should directly send 200 OK for
    ...
    /* fax request method:   0 for INVITE, 
					   	   1 for UPDATE */
	icf_uint8_t			fax_req_method;
    ...
    */
    ...
    /*CSR-1-6976670: A new bolean named check_remote_codec_list added in this structure 
     *that will indicate whether the newly received codec list from remote
     *needs to be checked against the codec list received in previous (last) SDP.
     *if it is TRUE then check_remote_codec_list is enabled and if it is FALSE then
     *it means it is disabled.By default this boolean will be FALSE
     */

    icf_boolean_t        check_remote_codec_list;

    /* CSR_1_7113139 Merged SPR 19672 Start */	
    /*SPR-19462 -A new bolean named inc_sdp_version_when_no_change added in this structure 
    that will indicate whether the application wants IPTK to increment SDP version.
    if it is TRUE then inc_sdp_version_when_no_change is enabled and if it is FALSE the 
    it means it is disabled.By default this boolean will be FALSE*/
...
#define ICF_COMMIT_RESTORATION_IN_PROGRESS  0x40
    /* The following bit will be set by MMI to indicate whether it sought
       local SDP while sending tunnelled MMS request. This bit will be
       reset after tunnelled MMS response is received from the application.
    */
#define ICF_MMI_LOCAL_SDP_REQD				    0x80
...
#define ICF_MMI_ONGOING_NONE			6
    ...
    /*SPR 19590 added the txn id in the mmi ctx for retrieving the
      same from the mmi ctx and re-storing it in the call ctx when
     mms resp is recv*/
    icf_uint32_t                    txn_id;
}icf_mmi_context_st;
...
#endif
    /* This is the tunnelled SDP struture in the call context */
    icf_tunnelled_sdp_info_st *p_tunnelled_sdp;    
...
/* CSR 1-6059146: SPR 18675: No need for this hash define. */
/* #define ICF_CC_TERM_CALL_ALREADY_SEND_TO_APP     0x00008000 */
#define ICF_PRECONDITION_REQD                    0x00010000
/*  CSR 1-5685130 Merge */
#define ICF_AUTH_INFO_ABSENT                     0x00020000

/*  SPR 18064 Merge */
#define ICF_AUTH_PARAM_NOT_RCVD                  0x00040000
/*spr18282 used for marking qos negotiation completion */
#define ICF_PRECONDITION_NEGOTIATION_DONE        0x00080000
/*CSR 1-6200296: new bitmask and new bit for clearing call on 415 for FAX*/
#define ICF_CLEAR_CALL_ON_FAX_FAILURE_415        0x00100000

#define ICF_FAILURE_RESPONSE_CODE_PRESENT        0x00200000

/* new bitmask to indicate if application has configured per call session timer
 * enable / disable */
#define ICF_SESSION_TIMER_FUNC_CONFIG_PER_CALL    0x00400000

    /* new bitmask to indicate if application has issued session timer toggle req */ 
#define ICF_SESSION_TIMER_TOGGLE_ISSUED           0x00800000

/* This bit is set when a generic message request is received from the application.
   This is used to indicate that processing is ongoing for a generic message request
   received from the application. If another request is received, and this bit is set, the
   the request will be rejected. This bit will be reset when a response to the 
   generic request has been sent to the application (ie a ICF_GENERIC_MSG_RESP has
   been sent to the application.)
*/   
#define ICF_GENERIC_MSG_REQ_ONGOING               0x01000000

/* This bit is set when a generic message request is received from the peer.
   This is used to indicate that processing is ongoing for a generic message request
   received from the peer. If another request is received, and this bit is set, the
   the request will be rejected with a 491. This bit will be reset when a response to the 
   generic request has been received from the the application (ie a ICF_GENERIC_MSG_CFM is
   received from the application).
*/  
#define ICF_GENERIC_MSG_IND_ONGOING               0x02000000

    /* This flag is set when Prack support field is filled */
#define ICF_PER_CALL_PRACK_FEATURE_ENABLED    0x04000000

    /*  This field would be true if incoming INVITE contains Require header
     *  It is taken for the case that INVITE received with 100rel in require
     *  header and application did not send prack in first 18x API
     */
#define ICF_REL_PROV_RESP_REQUIRED_BY_PEER 0x08000000

    /* new bitmask to indicate that the established call is emergency */ 
#define ICF_CALL_TYPE_EMERGENCY           	      0x10000000

/* This bit will be set when Call Modify Req is recevied from APP,
 * and reset when Call Modify Resp is sent to App.
 */
#define ICF_APP_CALL_MODIFY_REQ_ONGOING          0x20000000

/*  This bit will be set when NOTIFY will be challanged. IT is introduced to
 *  avoid the NOTIFY<-->401/407 Loop.
 */
#define ICF_NOTIFY_AUTHENTICATION_REQ            0X40000000

   icf_uint32_t             common_bitmask_2;
	 /* Fix for SPR Bug273 */
	 /* 
	  * This bit is set when failure response other then 401 and 407 of fax
	  * T.38 ReInvite is received and fax type is 
	  * ICF_T38_FAX_CALL_FAILURE_SWITCH_PT_CALL.
	  */
#define ICF_CALL_CHALLENGE_T38_FAILURE_SWITCH_PT 0x00000002
    
	icf_uint32_t             common_bitmask_3;
...
#define ICF_MEDIA_STREAM_REMOTE_RESUME 0x80
...
/*CSR 1-6188936:SPR 18835 : This indicates whether Allow header is received 
 * from remote and is update present in allow or not.
 */
/*This indicates when UPDATE is present in allow header*/
#define ICF_UPDATE_PRESENT_IN_ALLOW_HDR  0x01
#define ICF_ALLOW_HDR_RECEIVED           0x02
#define ICF_ALLOW_HDR_RCVD_WO_UPDATE     0x04
...
/*#ifdef ICF_LOAD_FORCEFUL_CALL_CLEAR
   ...
   /* This value is filled by dbm at time of call ctx creation from
      * configuration data. PA can overwrite this in case of outgoing call */
     icf_media_transport_mode_et  media_transport_type;

   /* uri parameter to be added in Request URI in case of outgoing call  
    * or recieved from the network in case of incoming call*/
   icf_string_st            *p_req_uri_param;
   icf_media_mode_t         recvd_media_attrib_backup;

   /*Warning Header response code, this will be set while 488 response code 
    *is to be sent on nw. This field will be populated by MMI */
   icf_uint32_t     warning_header_code;

   /*A boolean added to perform SRTP Fallback on per call basis */
   icf_boolean_t             srtp_fallback_reqd;

   /* This boolean will be set whenever application indicates tunnel
      mode of operation through API ICF_CREATE_CALL_REQ or 
      ICF_EARLY_INCOMING_CALL_CFM.
   */
   icf_boolean_t tunnel_mode;
   /*  THis boolean will be used in case of tunnel mode only
    * when UPDATE is received from network then it gets set
    * and when respons ehas been sent on network for UPDATE
    * then it gets reset
    */
   icf_boolean_t update_recv;

   /* This string shall be used store
    * To tag received in icf_call_modify_req
    */
   icf_uint8_t   *p_to_tag;

   /* This boolean shall be used for indicating the application that
    it's outgoing precondition call, however the same can be used
    for other cases when needs to get offer from SIP UE in tunnel mode.*/
   icf_boolean_t offer_received;
   /*Rel8.1 This boolean shall be initially set to false and once the INV 
     is recvd it is set to true and after INV is processed it is reset.
    This is reqd to do the handling in icf_ssa_get_media_parameter_from_sdp
    for INV message only*/
   icf_boolean_t inv_failure_handling_reqd;

   /*This boolean will be used to state whether IPTK or application shall 
     send the INVITE after receiving 302 response for initial INVITE*/         
   icf_boolean_t         redirect_support_reqd;

   /* This will be set whenever application indicates prack_support */
   icf_prack_values_et prack_value;

   /*  This field will indicate that System shall use system level 
    *  configuration for PRACK if it is true by default it is FALSE
    */
   icf_boolean_t system_level_configuration_for_prack;

   /* This filed is used to send the method name received in a 
      ICF_GENERIC_MSG_REQ from the application.In case this request
      is received from the application and some logical failure
      occurs (like call not being connected), then we will
      reject the request with ICF_GENERIC_MSG_RESP API. This field
      will be used in such a scenario to populate the method_name 
      field of the response API.
   */
   icf_string_st generic_req_method_name;
   icf_boolean_t rel_prov_resp;
   /* CSR 1-8780514 SPR 20517 */
   /* A new boolean is_sdp_received ias added
      to indicate whether 180 received is with SDP or without SDP */
   icf_boolean_t is_sdp_received;
   /*SPR 19491 This flag shall be default set to false and shall
     be set to TRUE when in early dialog call modify req (UPDATE)
     is being sent to network and it's response is awaited.*/
   icf_boolean_t call_modify_req_ongoing;
   /*SPR19574 Added media_connect_sent field to identify if the 183
     is sent during QOS tunnel call. Default it is false and after sending
     183 it is set to TRUE.*/
   icf_boolean_t media_connect_sent;

   /*This contains the node of types icf_msg_body_link_list_st */
    icf_list_st     *p_list_of_body_list;
    
    /*This contains the node of types icf_tag_link_list_st */
    icf_list_st     *p_list_of_tag_list;

   /* list of additional message headers of type icf_header_link_list_st*/
    icf_list_st     *p_list_of_header_list;

    /*This list shall contain the node of type icf_pending_event_txnid_st
      which has mapping for the txn_id used for the hdr list and the
      associated pending event*/
    icf_list_st     *p_pending_event_list;

    /*This shall be having the current message txn id to
      extract the correct node from the hdr list*/
    icf_uint32_t    txn_id;
    
    /*This shall be the counter which is every time incremented when
      adding the node in the list of header list structure*/
    icf_uint32_t    last_txn_id;

    /*SPR 19835 - This shall be used to indentify that the txn_id field
      should be reset or not. This shall be set when hdr/body list node
      is deleted from the call context.*/
    icf_boolean_t   reset_txn_id;

    /*SPR 19941 - This flag is set to true when the call ctx needs to
      be detached from line */
    icf_boolean_t   detach_cc_from_line;
    /*CSR 1-7546911 merge*/
    icf_transport_mode_t redirect_trans_mode;

    /* Fix For SPR:20101*/
    /* Boolean added to identify that we are in process of handing the incoming
     * UPDATE request with/without SDP before call
     * setup. Value as TRUE indicate the above behaviour and value as false
     * indicates no such request is currently being handled by IPTK.*/
    icf_boolean_t            is_call_modify_ongoing;
...
#define     ICF_MEDIA_REVERT_NULL                          0x2000 
    /* This bit will be set by CC whenever it requires local SDP from the
       aplication in tunnelled MMS response  */
#define ICF_LOCAL_SDP_REQD     0x4000
    /* This bit will be set by CC whenever it is sending remote SDP to
       the aplication in tunnelled MMS request  */
#define ICF_TUNNELLED_REMOTE_SDP_PRESENT 0x8000
    ...
    /*  It will contain the remote received codec list */
    icf_list_st                 *p_remote_recvd_codec_list;


    /*Fix Merged for CSR-1-6976670 */
    icf_list_st        *p_bckup_codec_from_remote;
    icf_list_st        *p_lastcommitted_codeclist_from_remote;
...
#define ICF_USER_DB_REALM_RECD              0x20    
    icf_uint32_t                flags;
...
typedef struct
{
    ...
    /* secondary proxy configured for this line */
    icf_transport_address_st     *p_sec_proxy_addr;
...
#define ICF_PEER_SUPPORTS_SIGCOMP_IS_UNKNOWN        2
    ...
    /* secondary registrar configured for this line */
    icf_transport_address_st     *p_sec_registrar_addr;

	/* This flag informs whether secondary proxy is currently active */
	icf_boolean_t				sec_proxy_server_active;

	/* This flag informs whether secondary registrar is currently active */
	icf_boolean_t				sec_registrar_active;
...
/* This bit shall be set if secondary proxy server address is received in
* transport request */
#define ICF_CFG_LINE_DATA_SEC_PROXY_RECD				 0x100
/* This bit shall be set if secondary registrar address is received in
* transport request */
#define ICF_CFG_LINE_DATA_SEC_REGISTRAR_RECD			 0x200

	icf_uint32_t                   line_data_received;
...
/*Changes for CSR_1-5671948*/
   /*To get the access network information at runtime*/
    ...
    /* IPTK will not send the route header in outgoing requests
   ...
   /* If this field is TRUE,IPTK will use Update method for session refresh
    * if allow header is not received from remote.This will be used only if
    * ICF_CFG_SESSION_REFRESH_METHOD_UPDATE is set i.e session refresh method
    * as Update is specified by the application either in set call params or in
    * set line params.
    */
...
typedef struct
{
    ...
    /*Below mentioned variables are added for load stats printing*/  
    icf_uint32_t    otg_message_attempts;
    icf_uint32_t    otg_message_success;
    icf_uint32_t    inc_message_attempts;
    icf_uint32_t    inc_message_success;
    icf_uint32_t    otg_publish_attempts;
    icf_uint32_t    otg_publish_success;
    icf_uint32_t    otg_cta_success;
    icf_uint32_t    otg_cta_attempts;
    icf_uint32_t    otg_session_refresh_success;
    icf_uint32_t    inc_session_refresh_attempts;
    icf_uint32_t    otg_session_refresh_attempts;
    icf_uint32_t    otg_start_fax_req;
    icf_uint32_t    call_modify_ind;
    icf_uint32_t    call_modify_resp_success;
    icf_uint32_t    call_modify_resp_fail;
    icf_uint32_t    call_modify_req;
    icf_uint32_t    start_fax_ind;
    icf_uint32_t    start_fax_resp_succ;
    icf_uint32_t    start_fax_resp_fail;
    icf_uint32_t    stop_fax_resp_succ;
    icf_uint32_t    stop_fax_resp_fail;
    icf_uint32_t    stop_fax_ind;
    icf_uint32_t    otg_stop_fax_req;
    icf_uint32_t    otg_session_refresh_invite;
    icf_uint32_t    otg_session_refresh_update;    
    icf_uint32_t    num_of_302_reponse_recv;
...
/*-----------------------------------------------------------------------------
 *
 * Structure Name: icf_func_fail_info_st
 *
 * Description: Structure to store the function name and the count
...
typedef struct
{
	...
	/* call count on which func has to return failure */
        icf_uint16_t                    func_ims_count; 
	/* to maintain current count of function call */
        icf_uint16_t                     func_icf_count;
	icf_error_t			ecode;
        /* Function level/encapsulating function name */  
        icf_string_st                   func_level_name;
       /*func_visited - value ICF_TRUE= encapsulating function visited, 
	* ICF_FALSE = encapsulating function not visited*/	
        icf_boolean_t		 	func_visited;
}icf_func_fail_info_st;
...
#ifdef ICF_UT_TEST
	icf_uint16_t		func_num; /* total num of funcs to be failed */
        /*function name, count and error code*/ 
	icf_func_fail_info_st 	func_fail_info[ICF_MAX_NUM_FUNC_FAIL];
	/*to store error code returned from func failed */
	icf_error_t		*p_ecode;

    /*This following variables are send by application(ims) to populate the
...
#endif
/* The flag ICF_KLOCWORK_SHOW_FALSE_POSITIVE is to remove false Klocwork's
 * static code analysis warnings. There is no functional code under this flag */
#ifndef ICF_KLOCWORK_SHOW_FALSE_POSITIVE
        icf_list_st* p_junk_temp;
        icf_list_st junk ;
        icf_list_st junk_1 ;
#endif
        /*Both p_rgm_ctx and p_sic_ctx are for future use*/
        icf_void_t              *p_rgm_ctx;
        icf_void_t              *p_sic_ctx;

        /*Line ID of the current request processing*/
        icf_line_id_t           line_id;
        /*CSR 1-7407479 merge*/
...
#endif
/*Fix Merged For CSR_1_5400409*/
#define ICF_CFG_CC_SET_CALL_PRM_MAX_ACTIVE_CALLS_PER_LINE    ICF_SET_CALL_PRM_MAX_ACTIVE_CALLS_PER_LINE
...
#define  ICF_CFG_CC_SET_CALL_PRM_ACCESS_NW_INFO	  ICF_SET_CALL_PRM_ACCESS_NW_INFO
#define ICF_CFG_CC_SET_CALL_PRM_PRECONDITION_REQD ICF_SET_CALL_PRM_PRECONDITION_REQD
#define ICF_CFG_CC_SET_CALL_PRM_MEDIA_TYPE_REQD   ICF_SET_CALL_PRM_MEDIA_TYPE_REQD
...
#define ICF_PA_CC_CREATE_CALL_REQ_PRECONDITION_REQD ICF_PRECONDITION_REQD_FLAG_PRESENT
#define ICF_PA_CC_CREATE_CALL_REQ_MEDIA_TYPE_REQD               ICF_MEDIA_TYPE_REQD_FLAG_PRESENT
...
/*-----------------------------------------------------------------------------
 *
 * Structure Name:  icf_header_link_list_st
 *
 * Description: This datatype represents a structure that contains a list
 *                of SIP headers for the incoming SIP message and the PA API
 *                headers. Additionally it contains the txn_id which maps 
 *                the SIP message or the PA API to hdr list.
 *---------------------------------------------------------------------------*/
typedef struct
{
    /*Transaction id which is used as key to fetch the header list
      from the call context list of header list*/
    icf_uint32_t       txn_id;

    /*Header list of a SIP message or PA API*/
    icf_header_list_st header_list; 
} icf_header_link_list_st;

/*-----------------------------------------------------------------------------
 *
 * Structure Name:  icf_msg_body_link_list_st
 *
 * Description: This datatype represents a structure that contains a list
 *                of SIP bodies for the incoming SIP message and the PA API
 *                msg bodies. Additionally it contains the txn_id which maps 
 *                the SIP message or the PA API to hdr list.
 *---------------------------------------------------------------------------*/
typedef struct
{
    /*Transaction id which is used as key to fetch the body list
      from the call context list of body list*/
    icf_uint32_t         txn_id;
    
    /*Body list of SIP message or PA API*/
    icf_msg_body_list_st body_list; 
} icf_msg_body_link_list_st;

/*-----------------------------------------------------------------------------
 *
 * Structure Name:  icf_tag_link_list_st
 *
 * Description: This datatype represents a structure that contains a list
 *                of tags for the incoming SIP message and the PA API
 *                tags. Additionally it contains the txn_id which maps 
 *                the SIP message or the PA API to hdr list.
 *---------------------------------------------------------------------------*/
typedef struct
{
    /*Transaction id which is used as key to fetch the tag list
      from the call context list of tag list*/
    icf_uint32_t         txn_id;
    
    /*Tag list of SIP message or PA API*/
    icf_tag_list_st tag_list; 
} icf_tag_link_list_st;


/*-----------------------------------------------------------------------------
 *
 * Structure Name:  icf_pending_event_txn_id_st
 *
 * Description: This datatype represents a structure that contains a
 *              transaction_id and associated pending event. This shall be
 *              used to store the SIP message or PA API header/body/tag lists
 *              txn id and the associated pending event in CC. This is used
 *              for fetching the correct txn id which is further used to fetch
 *              header/body/tag lists from call ctx when the pending event 
 *              gets processed.
 *---------------------------------------------------------------------------*/
typedef struct
{
    /*This shall be the txn id stored in the pending_event list when
      marking the event pending in CC, this txn id has a node for header
      /body/tag lists of call ctx hdr/body/tag link lists. This shall be
      used for fetching the correct header/body/tag list node when this
      pending event identified by pending_event field is processed.*/
    icf_uint32_t txn_id;

    /*This shall be the pending event set in the call ctx*/
    icf_uint32_t pending_event;
} icf_pending_event_txnid_st;
/*SPR 19590 changes end*/


/* This type stores the challenge algo received from the network.
 * It is stored in ssa context and rgm context via the function
 * icf_ssa_extract_challenge.It has two poosible values :
 *       1 : For AKA
 *       2 : For MD5
 * This data type is being used while forming a response to the 
 * challenge.
 */
typedef icf_uint8_t icf_challenge_algo_t;


/*  SPR 18064 Merge */
/*----------------------------------------------------------------------------- 
* * NAME : icf_pa_cc_terminate_user_term_call_resp 
* * DESCRIPTION  : This data type is used to define a structure, which specifies 
*                payload data of API ICF_CC_PA_TERMINATE_CALL_RESP.  
*                
----------------------------------------------------------------------------*/
typedef icf_remote_user_term_call_resp_st  icf_cc_pa_remote_user_term_call_resp_st;

/* Refer-Notify enhancements */
/*----------------------------------------------------------------------------- 
*   NAME          : icf_pa_cc_generic_msg_req_st 
*   DESCRIPTION  :  This data type is used to define a structure, which specifies 
*                   payload data of API ICF_GENERIC_MSG_REQ.  
*                
----------------------------------------------------------------------------*/
typedef icf_generic_msg_req_st icf_pa_cc_generic_msg_req_st;
