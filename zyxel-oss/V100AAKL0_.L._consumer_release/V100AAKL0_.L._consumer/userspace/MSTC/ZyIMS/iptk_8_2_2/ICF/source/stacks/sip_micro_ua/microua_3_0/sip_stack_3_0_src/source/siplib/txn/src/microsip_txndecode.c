 ...
 ** 15/04/2009  Kamal Ashraf            IPTK REL 8.2           SPR-19309 Merged(CSR 1-7080940)  
...
#endif
{
    ...
    /*IPTK CSR 1-7757056 fix to remove UMR*/
    txnInformn.dRespClass = SipResponseInvalid;
...
/*CSR_1-4868194 ends*/			
		...
		pKey->dRespCodeNum = pMessage->u.pResponse->pStatusLine->dIntVar1;
	}
