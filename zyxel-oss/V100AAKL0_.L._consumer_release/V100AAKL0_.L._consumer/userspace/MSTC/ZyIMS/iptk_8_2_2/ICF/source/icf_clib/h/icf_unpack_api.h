/*******************************************************************************
*										
* FILE NAME    :icf_unpack_api.h
*										
* DESCRIPTION  :The file contains declarations for the buffer unpacking code.
...
* 05-Jul-2008   Amit Sharma     SPR:18714       Unpacking icf_display_ind_st
...
* 11-Feb-2009   Ashutosh Mohan  IPTK Rel8.1     Added support for following:
*                                               icf_unpack_update_req_send_st
...
* 15-Mar-2009   Anuradha Gupta   IPTK 8.1       Added prototypes for Timer Enh
* 30-Mar-2009   Abhishek Dhammawat Rel 8.2      Added prototypes for
*                                               REFER/NOTIFY Enhancements
* 31-Mar-2009   Preksha            Rel 8.2      Added prototypes for
*                                               PRACK Enhancements
...
#ifndef __ICF_UNPACK_API__H__
#define __ICF_UNPACK_API__H__
...
icf_uint32_t
icf_unpack_icf_call_transfer_unattended_req_st
(
    icf_uint8_t    *p_dest,
    icf_uint8_t    *p_src,
    icf_uint32_t *p_length
...
/*  XCONF API Functions DEclarations */
...
icf_uint32_t
icf_unpack_icf_call_mod_cancel_resp_st
(
        icf_uint8_t             *p_dest,
        icf_uint8_t             *p_src,
        icf_uint32_t    *p_length
...
icf_uint32_t
icf_unpack_icf_hold_option_st( icf_uint8_t    *p_dest,
                               icf_uint8_t    *p_src,
                               icf_uint32_t   *p_length );
...
icf_uint32_t 
icf_unpack_icf_stop_fax_resp_st(icf_uint8_t    *p_dest,
                                icf_uint8_t    *p_src,
                                icf_uint32_t   *p_length);

icf_uint32_t 
icf_unpack_icf_stop_fax_req_st(icf_uint8_t    *p_dest,
                               icf_uint8_t    *p_src,
                               icf_uint32_t   *p_length);

icf_uint32_t 
icf_unpack_icf_stop_fax_ind_st(icf_uint8_t    *p_dest,
                               icf_uint8_t    *p_src,
                               icf_uint32_t   *p_length);
...
icf_uint32_t
icf_unpack_icf_remote_call_transfer_initiated_cfm_st
(
    icf_uint8_t    *p_dest,
    icf_uint8_t    *p_src,
    icf_uint32_t *p_length
...
/*icf_uint32_t
icf_unpack_icf_reg_status_list_st
(
    icf_reg_status_list_st    **p_p_icf_reg_status_list_st,
    icf_uint8_t    *p_src,
    icf_uint32_t   *p_length
);*/
...
icf_uint32_t
icf_unpack_icf_get_register_status_req_st
(
           icf_uint8_t      *p_dest,
           icf_uint8_t      *p_src,
           icf_uint32_t     *p_length
...
icf_uint32_t
icf_unpack_icf_get_register_status_resp_st
(
           icf_uint8_t      *p_dest,
           icf_uint8_t      *p_src,
           icf_uint32_t     *p_length
...
icf_uint32_t
icf_unpack_icf_uatk_api_test_st
(
        icf_uint8_t     *p_dest,
        icf_uint8_t     *p_src,
        icf_uint32_t    *p_length
...
/* A new function which shall unpack a list*/
/*RETURN : icf_uint32_t */
...
/*Prototype for unpacking function of ICF_GENERIC_MSG_REQ */
icf_uint32_t
...
/*Prototype for unpacking function of ICF_GENERIC_MSG_RESP */
icf_uint32_t
...
/*Prototype for unpacking function of ICF_GENERIC_MSG_IND */
icf_uint32_t
...
/*Prototype for unpacking function of ICF_GENERIC_MSG_CFM */
icf_uint32_t
...
/*Added prototype for unpacking function of ICF_PRACK_REQ_RECV_IND API*/
icf_uint32_t
...
/*Added prototype for unpacking function of ICF_PRACK_RESP_SENT_IND API*/
icf_uint32_t
...
/*Added prototype for unpacking function of ICF_PRACK_REQ_SENT_IND API*/
icf_uint32_t
...
/*Added prototype for unpacking function of ICF_PRACK_RESP_RECV_IND API*/
icf_uint32_t
...
/*Added prototype for unpacking function of ICF_MESSAGE_CFM API*/
icf_uint32_t
