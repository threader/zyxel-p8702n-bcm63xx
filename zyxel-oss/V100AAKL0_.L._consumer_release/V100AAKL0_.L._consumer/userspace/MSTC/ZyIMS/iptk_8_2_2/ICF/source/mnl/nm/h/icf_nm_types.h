...
#ifdef ICF_QOS_SUPPORT
/*Max number of QOS_MAP entries will be calculated from audio+video+service calls from icf_defs.h*/
#define ICF_MAX_NUM_OF_QOS_MAPS\
      ICF_DEFAULT_MAX_AUDIO_CALLS + ICF_DEFAULT_MAX_VIDEO_CALLS + ICF_DEFAULT_MAX_SERVICE_CALLS
    /* converted to array of pointer for mul
       call support */
	icf_nm_non_ims_qos_map_st	 *p_non_ims_qos_map[ICF_MAX_NUM_OF_QOS_MAPS];
    /*counter for QOS calls */
    icf_uint8_t                  call_index;
#endif
}icf_nm_global_st;
