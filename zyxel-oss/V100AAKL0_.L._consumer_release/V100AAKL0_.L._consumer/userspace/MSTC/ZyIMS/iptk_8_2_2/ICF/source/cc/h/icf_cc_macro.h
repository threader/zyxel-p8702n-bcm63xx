 ...
 * 11-Jun-2009  Abhishek Dhammawat               Modified the pending set
 *                                               macro for adding node to
 *                                               pending event list in call
 *                                               ctx
...
{                                                                           \
    p_cc_pdb->p_call_ctx->pending_event |= bit;                             \
    ret_val = icf_cc_add_node_to_pending_event_list_in_call_ctx( \
            p_cc_pdb, \
            bit);\
}
...
{                                                                           \
    p_cc_pdb->p_call_ctx->pending_event &= (~(bit));                        \
    ret_val = icf_cc_del_node_from_pending_event_list_in_call_ctx(\
            p_cc_pdb,\
            bit);\
}
