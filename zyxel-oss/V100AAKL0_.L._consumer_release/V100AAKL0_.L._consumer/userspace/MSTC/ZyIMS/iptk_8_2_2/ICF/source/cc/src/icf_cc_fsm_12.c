 ...
 * 09-Jun-2008  Tarun Gupta     SPR 18585           Modified icf_cc_12_start_call_proc_sig
 *
        ...
        INOUT icf_cc_pdb_st *p_cc_pdb)
{
    ...
    /*  SPR 17993 Merge */
    if(ICF_PENDING_EVENT_PA_STOP_FAX_REQ == ICF_CC_CHECK_PENDING_EVENT(\
           p_cc_pdb,ICF_PENDING_EVENT_PA_STOP_FAX_REQ))
    {
        icf_config_data_st  *p_config_data = ICF_NULL;
        /*  Fix for CSR 1-5947245 */
        ICF_CC_RESET_PENDING_EVENT(\
           p_cc_pdb,ICF_PENDING_EVENT_PA_STOP_FAX_REQ)

        ICF_CC_SET_ONGOING_EVENT(\
           p_cc_pdb,ICF_CC_PA_STOP_FAX_REQ)
