 ...
 ** 12/05/03    Subbarao	   UATK 2.1     RFC 3428 feature added.
 **                            Design      
 ...
 ** 28-Jul-2009 Tarun Gupta     SPR 19895    Modified sdf_ivk_uaIPTKCheckMessageLength
 ** 28-Jul-2009 Rajiv kumar     SPR 19896    Resolved stand alone compilation
 **                                          issues of UATK.
 ** 23-Sep-2009 Tarun Gupta     SPR 20063    Merged CSR 1-7735751
...
/* klocowrks : NULL checks have been added before pointer access at reported locations
 */
...
#endif
{
  ...
  /*Enhancement Change End*/
    ...
    /* Fix for UATK CSR 1-7770201: IPTK CSR 1-7735751 */
#ifdef SIP_BADMESSAGE_PARSING 
	...
	/*CSR 3776004*/
    /*SPR- 19314 fixed*/
    /* Fix for CSR_1-5516815*/
    else if(Sdf_en_sipIncomplete == dErr1.stkErrCode)
    {
...
/* Fix for spr 17191 end */
    ...
    /* CSR_1-5976760 Change Start */	
   if(((Sdf_en_invite == dMsgType)&&((SipMessageRequest == dReqRespType)||((SipMessageResponse ==dReqRespType) && (200 == dRespCode))))
#ifdef SIP_IMPP
		||(( Sdf_en_subscribe == dMsgType) && (SipMessageResponse ==dReqRespType) && (200 == dRespCode)) 
#endif
    )
/* CSR_1-5976760 Change ends */
  {
/* CSR_1-5250732 Change Start */
...
#endif
{
  ...
  Sdf_ty_bool dIsErrorHandled = Sdf_co_false;
	...
	if ( ((Sdf_co_null != ppSipTxnKey) && (*ppSipTxnKey) != pIncomingTxnKey) && \
...
#endif
{
	...
	while(dIterator.pCurrentElement != Sdf_co_null)
	{
		...
		if (Sdf_co_null != pRemoteRetransBuffer)
		{
