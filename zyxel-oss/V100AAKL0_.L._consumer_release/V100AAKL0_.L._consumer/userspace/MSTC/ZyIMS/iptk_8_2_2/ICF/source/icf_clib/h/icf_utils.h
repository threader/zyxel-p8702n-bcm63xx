...
* --------    ------------        ----         ----------
* 08-JUL-2005   Ram Narayan        None         Initial
* 14-Jun-2009 Abhishek Dhammawat   SPR19590     modified ICF_CLIB_MAX_LIST_NODES
* 03-Sep-2009 Abhishek Dhammawat   SPR20016     modified MAX API length define
*   										
...
#define ICF_CLIB_MAX_LIST_NODES (200)

/* Defines the Maximum String length*/
#define ICF_CLIB_MAX_STR_LEN (512)

/* API length should not be greater then to this*/
/*SPR 20016 Modified the MAX API length to 30000*/
#define ICF_CLIB_MAX_API_LENGTH (30000)

/* Temporary Buffer For storing the arbitrary length API, Size of buffer
 *should be defined with ICF_MAX_API_PAYLOAD_LENGTH defined in icf_defs.h*/
#define ICF_CLIB_MAX_TEMP_ARBI_BUFF_LENGTH ICF_MAX_API_PAYLOAD_LENGTH
