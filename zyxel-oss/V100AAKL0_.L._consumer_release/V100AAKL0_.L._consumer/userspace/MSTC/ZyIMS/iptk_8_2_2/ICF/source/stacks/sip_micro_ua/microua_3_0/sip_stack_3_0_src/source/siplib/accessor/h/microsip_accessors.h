 ...
 ** 28-Jan-2009     Kamal Ashraf    IPTK Rel 8.1    ProtoType added for APIs
...
/*ProtoType for the APIs added for IPTK Rel 8.1(UATK Enhancement)*/
...
**
*********************************************************************/
extern SipBool sip_getIPTKHeaderAsStringAtIndex _ARGS_ ((SipMessage *s, \
