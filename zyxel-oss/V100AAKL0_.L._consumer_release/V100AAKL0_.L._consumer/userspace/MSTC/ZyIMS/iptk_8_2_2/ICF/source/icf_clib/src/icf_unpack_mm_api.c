...
* 11-Feb-2009     Ashutosh Mohan       IPTK Rel8.1       Added code for tunnelled APIs
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_encoded_attributes_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_encoded_attributes_list_st) (*p_p_icf_encoded_attributes_list_st)->p_data = (icf_string_st*)ICF_CLIB_MEMGET(sizeof(icf_string_st));
		
		if ( (*p_p_icf_encoded_attributes_list_st) && ((*p_p_icf_encoded_attributes_list_st)->p_data)) icf_unpack_icf_string_st((icf_uint8_t*)((*p_p_icf_encoded_attributes_list_st)->p_data), p_src + (*p_length), &offset);
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_codec_attrib_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_codec_attrib_list_st) (*p_p_icf_codec_attrib_list_st)->p_data = (icf_codec_attrib_st*)ICF_CLIB_MEMGET(sizeof(icf_codec_attrib_st));
		
		if ((*p_p_icf_codec_attrib_list_st) && ((*p_p_icf_codec_attrib_list_st)->p_data)) icf_unpack_icf_codec_attrib_st((icf_uint8_t*)((*p_p_icf_codec_attrib_list_st)->p_data), p_src + (*p_length), &offset, stream_type);
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_stream_capab_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_stream_capab_list_st) (*p_p_icf_stream_capab_list_st)->p_data = (icf_stream_capab_st*)ICF_CLIB_MEMGET(sizeof(icf_stream_capab_st));
		
		if ( (*p_p_icf_stream_capab_list_st)  && ((*p_p_icf_stream_capab_list_st)->p_data)) icf_unpack_icf_stream_capab_st((icf_uint8_t*)((*p_p_icf_stream_capab_list_st)->p_data), p_src + (*p_length), &offset);
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_stream_commit_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_stream_commit_list_st) (*p_p_icf_stream_commit_list_st)->p_data = (icf_stream_commit_st*)ICF_CLIB_MEMGET(sizeof(icf_stream_commit_st));
		
		if ((*p_p_icf_stream_commit_list_st) && ((*p_p_icf_stream_commit_list_st)->p_data)) icf_unpack_icf_stream_commit_st((icf_uint8_t*)((*p_p_icf_stream_commit_list_st)->p_data), p_src + (*p_length), &offset);
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_channel_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_channel_list_st) (*p_p_icf_channel_list_st)->p_data = (icf_channel_st*)ICF_CLIB_MEMGET(sizeof(icf_channel_st));
		
		if ( (*p_p_icf_channel_list_st) && ((*p_p_icf_channel_list_st)->p_data))  icf_unpack_icf_channel_st((icf_uint8_t*)((*p_p_icf_channel_list_st)->p_data), p_src + (*p_length), &offset);
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_channel_addr_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_channel_addr_list_st) (*p_p_icf_channel_addr_list_st)->p_data = (icf_channel_addr_st*)ICF_CLIB_MEMGET(sizeof(icf_channel_addr_st));
		
		if ( (*p_p_icf_channel_addr_list_st) && ((*p_p_icf_channel_addr_list_st)->p_data))  icf_unpack_icf_channel_addr_st((icf_uint8_t*)((*p_p_icf_channel_addr_list_st)->p_data), p_src + (*p_length), &offset);
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_req_stream_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_req_stream_list_st) (*p_p_icf_req_stream_list_st)->p_data = (icf_req_stream_st*)ICF_CLIB_MEMGET(sizeof(icf_req_stream_st));
		
		if ( (*p_p_icf_req_stream_list_st) && ((*p_p_icf_req_stream_list_st)->p_data)) icf_unpack_icf_req_stream_st((icf_uint8_t*)((*p_p_icf_req_stream_list_st)->p_data), p_src + (*p_length), &offset);
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_resp_stream_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_resp_stream_list_st) (*p_p_icf_resp_stream_list_st)->p_data = (icf_resp_stream_st*)ICF_CLIB_MEMGET(sizeof(icf_resp_stream_st));
		
		if ( (*p_p_icf_resp_stream_list_st) && ((*p_p_icf_resp_stream_list_st)->p_data)) icf_unpack_icf_resp_stream_st((icf_uint8_t*)((*p_p_icf_resp_stream_list_st)->p_data), p_src + (*p_length), &offset);
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_modify_stream_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_modify_stream_list_st) (*p_p_icf_modify_stream_list_st)->p_data = (icf_modify_stream_st*)ICF_CLIB_MEMGET(sizeof(icf_modify_stream_st));
		
		if ( (*p_p_icf_modify_stream_list_st) && ((*p_p_icf_modify_stream_list_st)->p_data)) icf_unpack_icf_modify_stream_st((icf_uint8_t*)((*p_p_icf_modify_stream_list_st)->p_data), p_src + (*p_length), &offset);
...
)
{
	...
	*p_length    += offset;
	...
	while((count<p_icf_merge_media_session_req_st->count) && (count < ICF_MAX_CODECS))
	{
...
)
{
    ...
    *p_length    += offset;
    ...
    icf_unpack_icf_line_id_t((icf_uint8_t*)&(p_icf_media_capabilities_resp_st->line_id),p_src + (*p_length), &offset); 
  	*p_length    += offset;
	...
	*p_length    += offset;
	...
	while(count--)
    {
		...
		*p_p_icf_encoded_params_list_st = (icf_list_st *)ICF_CLIB_MEMGET(sizeof(icf_list_st));
		...
		if (*p_p_icf_encoded_params_list_st) (*p_p_icf_encoded_params_list_st)->p_data = (icf_string_st*)ICF_CLIB_MEMGET(sizeof(icf_string_st));
		
		if ( (*p_p_icf_encoded_params_list_st) && ((*p_p_icf_encoded_params_list_st)->p_data)) icf_unpack_icf_string_st((icf_uint8_t*)((*p_p_icf_encoded_params_list_st)->p_data), p_src + (*p_length), &offset);
...
)
{
    ...
    *p_length    += offset;
    ...
    icf_unpack_icf_line_id_t((icf_uint8_t*)&(p_icf_media_capabilities_req_st->line_id), p_src + (*p_length), &offset) ; 
        *p_length    += offset;
...
/*****************************************************************************
*
* FUNCTION: icf_unpack_icf_tunnelled_create_media_session_req_st
*
* DESCRIPTION: This function is used to unpack the 
*              icf_unpack_icf_tunnelled_create_media_session_req_st
*
*****************************************************************************/
...
)
{
    ...
    p_icf_tunnelled_create_media_session_req_st = (icf_tunnelled_create_media_session_req_st *)p_dest;
    ...
    *p_length    = 0;
    ...
    icf_unpack_U8((icf_uint8_t*)&\
        (p_icf_tunnelled_create_media_session_req_st->bit_mask),p_src + (*p_length), &offset);
    ...
    *p_length    += offset;
        ...
        ICF_TUNNELLED_CMS_REQ_LINE_ID_PRESENT)
    {
        icf_unpack_icf_line_id_t((icf_uint8_t*)&\
            (p_icf_tunnelled_create_media_session_req_st->line_id),p_src + (*p_length), &offset);
    
        *p_length    += offset;
    }

    if(p_icf_tunnelled_create_media_session_req_st->bit_mask & 
        ICF_TUNNELLED_CMS_REQ_SDP_INFO_PRESENT)
    {

        icf_unpack_icf_tunnelled_sdp_info_st((icf_uint8_t*)&\
            (p_icf_tunnelled_create_media_session_req_st->tunnelled_sdp_info),p_src + (*p_length), &offset);
...
/*****************************************************************************
*
* FUNCTION: icf_unpack_icf_tunnelled_create_media_session_resp_st
*
* DESCRIPTION: This function is used to unpack the 
*              icf_unpack_icf_tunnelled_create_media_session_resp_st
*
*****************************************************************************/
...
)
{
    ...
    p_icf_tunnelled_create_media_session_resp_st = (icf_tunnelled_create_media_session_resp_st *)p_dest;
    ...
    *p_length    = 0;
    ...
    icf_unpack_U8((icf_uint8_t*)&\
        (p_icf_tunnelled_create_media_session_resp_st->result),p_src + (*p_length), &offset);
    
    *p_length    += offset;
 
    icf_unpack_U8((icf_uint8_t*)&\
        (p_icf_tunnelled_create_media_session_resp_st->bit_mask),p_src + (*p_length), &offset);
    
    *p_length    += offset;
 
    if(p_icf_tunnelled_create_media_session_resp_st->bit_mask & ICF_TUNNELLED_CMS_RESP_ERROR_CAUSE_PRESENT)
    {
        icf_unpack_U16((icf_uint8_t*)&\
            (p_icf_tunnelled_create_media_session_resp_st->error_cause),p_src + (*p_length), &offset);
    
        *p_length    += offset;
    }

    if(p_icf_tunnelled_create_media_session_resp_st->bit_mask & ICF_TUNNELLED_CMS_RESP_SDP_INFO_PRESENT)
    {
     
        icf_unpack_icf_tunnelled_sdp_info_st((icf_uint8_t*)&\
            (p_icf_tunnelled_create_media_session_resp_st->tunnelled_sdp_info),p_src + (*p_length), &offset);
...
/*****************************************************************************
*
* FUNCTION: icf_unpack_icf_tunnelled_modify_media_session_req_st
*
* DESCRIPTION: This function is used to unpack the 
*              icf_unpack_icf_tunnelled_modify_media_session_req_st.
*
*****************************************************************************/
...
)
{
    ...
    p_icf_tunnelled_modify_media_session_req_st = (icf_tunnelled_modify_media_session_req_st *)p_dest;
    ...
    *p_length    = 0;
    ...
    icf_unpack_U8((icf_uint8_t*)&(p_icf_tunnelled_modify_media_session_req_st->bit_mask),p_src + (*p_length), &offset);
    
    *p_length    += offset;

    icf_unpack_U8((icf_uint8_t*)&\
            (p_icf_tunnelled_modify_media_session_req_st->local_sdp_reqd),p_src + (*p_length), &offset);
    
    *p_length    += offset;

    if(p_icf_tunnelled_modify_media_session_req_st->bit_mask & ICF_TUNNELLED_MMS_REQ_SDP_INFO_PRESENT)
    {
       
        icf_unpack_icf_tunnelled_sdp_info_st((icf_uint8_t*)&\
            (p_icf_tunnelled_modify_media_session_req_st->tunnelled_sdp_info),p_src + (*p_length), &offset);
...
/*****************************************************************************
*
* FUNCTION: icf_unpack_icf_tunnelled_modify_media_session_resp_st
*
* DESCRIPTION: This function is used to unpack the 
*              icf_unpack_icf_tunnelled_modify_media_session_resp_st
*              
*
*****************************************************************************/
...
)
{
    ...
    p_icf_tunnelled_modify_media_session_resp_st = (icf_tunnelled_modify_media_session_resp_st *)p_dest;
    ...
    *p_length    = 0;
    ...
    icf_unpack_U8((icf_uint8_t*)&(p_icf_tunnelled_modify_media_session_resp_st->result),p_src + (*p_length), &offset);
    
    *p_length    += offset;
    
    icf_unpack_U8((icf_uint8_t*)&(p_icf_tunnelled_modify_media_session_resp_st->bit_mask),p_src + (*p_length), &offset);
    
    *p_length    += offset;


    if(p_icf_tunnelled_modify_media_session_resp_st->bit_mask & ICF_TUNNELLED_MMS_RESP_ERROR_CAUSE_PRESENT)
    {

        icf_unpack_U16((icf_uint8_t*)&\
            (p_icf_tunnelled_modify_media_session_resp_st->error_cause),p_src + (*p_length), &offset);
    
        *p_length    += offset;
    }

    if(p_icf_tunnelled_modify_media_session_resp_st->bit_mask & ICF_TUNNELLED_MMS_RESP_SDP_INFO_PRESENT)
    {
        icf_unpack_icf_tunnelled_sdp_info_st((icf_uint8_t*)&\
            (p_icf_tunnelled_modify_media_session_resp_st->tunnelled_sdp_info),p_src + (*p_length), &offset);
...
/*****************************************************************************
*
* FUNCTION: icf_unpack_icf_tunnelled_media_capabilities_resp_st
*
* DESCRIPTION: This function is used to unpack the 
*              icf_unpack_icf_tunnelled_media_capabilities_resp_st
*              
*
*****************************************************************************/
...
)
{
    ...
    p_icf_tunnelled_med_cap_resp_st    = (icf_tunnelled_media_capabilities_resp_st *)p_dest;
    ...
    *p_length    = 0;
    ...
    icf_unpack_U8((icf_uint8_t*)&(p_icf_tunnelled_med_cap_resp_st->\
        bit_mask), p_src + (*p_length),&offset);
    
    *p_length    += offset;

    icf_unpack_U8((icf_uint8_t*)&(p_icf_tunnelled_med_cap_resp_st->\
        result),p_src + (*p_length), &offset);
    ...
    *p_length    += offset;
    ...
    if(p_icf_tunnelled_med_cap_resp_st->bit_mask & ICF_TUNNELLED_MED_CAP_RESP_ERROR_CAUSE_PRESENT)
    {
        ...
        icf_unpack_U16((icf_uint8_t*)&(p_icf_tunnelled_med_cap_resp_st->\
            error_cause),p_src + (*p_length), &offset);
    ...
    if(p_icf_tunnelled_med_cap_resp_st->bit_mask & ICF_TUNNELLED_MED_CAP_RESP_SDP_INFO_PRESENT)
    {
        ...
        icf_unpack_icf_tunnelled_sdp_info_st((icf_uint8_t*)&\
            (p_icf_tunnelled_med_cap_resp_st->tunnelled_sdp_info),p_src + (*p_length), &offset);
