 ...
 **                                             request handlers
 ** 08-Apr-2008 Amit Sikka      SPR 18380   Updated for set_service_param req
 *****************************************************************************
...
iptkapp_return_t iptkapp_cfg_send_app_add_iptk(iptkapp_error_t *p_err)
{
	...
	/* Required to be made FALSE if application don't have 
	info regarding line concept */
...
iptkapp_return_t iptkapp_cfg_send_service_params_iptk(p_err)
{
