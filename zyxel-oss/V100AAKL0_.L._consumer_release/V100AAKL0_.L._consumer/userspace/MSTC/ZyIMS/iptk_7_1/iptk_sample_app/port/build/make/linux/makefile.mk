...
#export CPU=PENTIUM
export CPU=intel
#export SAMPLE_PROGRAM_BASE=/home2/vliao/zyvoice_4.02L.01/userspace/ZyXEL/new_voip/iptk_7_1/
export IPTKAPP_BASE=$(SAMPLE_PROGRAM_BASE)$(IPTKAPP_SLASH)iptk_sample_app
export ICF_BASE=$(SAMPLE_PROGRAM_BASE)$(IPTKAPP_SLASH)ICF
export CP=cp
...
CFLAGS_CMN          =  $(COPTIONS) -D__ANSI_C__ -DICF_PORT_LINUX -DICF_TRACE_ENABLE
