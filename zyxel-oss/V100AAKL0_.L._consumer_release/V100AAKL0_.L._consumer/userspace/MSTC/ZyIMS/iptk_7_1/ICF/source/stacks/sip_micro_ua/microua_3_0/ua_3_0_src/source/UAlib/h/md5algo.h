...
#ifdef SDF_LINT
void sdf_MD5Init SDF_PROTO ((SDF_MD5_CTX *context));

void sdf_MD5Update SDF_PROTO ((SDF_MD5_CTX *context, unsigned char *input, \
            unsigned int inputLen));

void sdf_MD5Final SDF_PROTO ((unsigned char digest[16], SDF_MD5_CTX *context));
