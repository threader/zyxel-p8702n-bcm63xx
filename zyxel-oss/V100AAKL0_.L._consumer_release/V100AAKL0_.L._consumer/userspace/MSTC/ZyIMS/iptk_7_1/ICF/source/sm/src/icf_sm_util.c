...
*/        
        ...
        if (ICF_NULL != p_error_data)
        {
            ...
            /*  In this the icf_call_id_t is a unsigned 16 bit integer so
             *  it must be type cast with icf_uint16_t and not with
             *  icf_unit8_t. */
            ...
            for (val_index = 0; val_index < p_error_data->num_of_integer_values;
                    val_index++)
            {
            ...
            for (val_index = 0;val_index < p_error_data->number_of_string_values;
                    val_index++)
            {
