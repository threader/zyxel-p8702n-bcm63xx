...
#endif
{
	...
	{
		dCodenum= (SIP_U16bit)pMessage->u.pResponse->pStatusLine->dIntVar1;
...
#endif
{
	...
	SipBool	   dToTagMatch = SipSuccess; /* Forked RPR fix */
...
#endif
{
    ...
    dCreate=!TXN_CREAT;
#endif
	dResult= FETCH_TXN((SIP_Pvoid *)&pTxnBuffer,pTxnKey,pContextData, \
				dCreate,pError);
	if (dResult==SipFail)
	{
...
#ifdef SIP_RETRANSCALLBACK
			if(pTxnBuffer->dEnableRetransCallback)
		    {
