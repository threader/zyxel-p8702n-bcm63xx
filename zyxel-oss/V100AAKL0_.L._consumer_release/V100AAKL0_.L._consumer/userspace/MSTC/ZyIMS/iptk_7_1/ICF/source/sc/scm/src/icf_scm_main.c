 ...
 *                                            feature.  
 * 31-Oct-2008  Puneet Sharma                CSR 1-6495401
 *
...
{
    icf_error_t         *p_ecode = &((p_msg->msg_hdr).ecode);
    icf_scm_pdb_st      pdb;
    icf_result_t        ret_val = ICF_SUCCESS;
    icf_scm_data_st     *p_scm_data = ICF_NULL;
    icf_glb_pdb_st      *p_glb_pdb = p_msg->msg_hdr.p_glb_pdb;
    ...
    {
        /*CSR 1-6495401: In case the call context has been freed,
		  return failure*/
