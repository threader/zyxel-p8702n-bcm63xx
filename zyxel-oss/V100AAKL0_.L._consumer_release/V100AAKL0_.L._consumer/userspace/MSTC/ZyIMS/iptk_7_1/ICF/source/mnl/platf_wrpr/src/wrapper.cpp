...

{
    ...
    p_param->str_len=(icf_uint16_t)len;
...

	{
...

		{
...

			{
				...
				octets[3-num_octets]=(icf_uint8_t)current_val;
...

{
    ...
    char temp_buf1[100],temp_buf2[32];
	...
	*p_port_ret_val=ICF_PORT_PLTFM_FAILURE;
...

    {
...

        {
			...
			p_host_to_ip_rsp->str_len=(icf_uint16_t )strlen(temp_buf2);
...

    {
        ...
        */
...

        {
            ...
            p_host_to_ip_rsp->str_len=(icf_uint16_t )(strlen((char *)p_host_to_ip_rsp->str));
