...
extern SipBool sip_formEachHeader _ARGS_ ((SIP_U32bit cpiter,\
	SipOptions *opt,SipMessage *s, \
		SIP_S8bit *out,SIP_U32bit siplistmap[],SipError *err));

/* Fix for IPTK CSR 1-8047728: SPR 20246 */
extern SipBool sip_formSingleHeader _ARGS_ ((en_HeaderType hdrtype,\
	SipOptions *popt,SIP_U32bit ndx,en_AdditionMode mode,\
...
extern SipBool sip_formSdpBody _ARGS_((SdpMessage *s, SIP_S8bit *out, \
	SipError *err));
...
#ifdef SIP_MWI
extern SipBool sip_formMesgSummaryBody _ARGS_(( \
