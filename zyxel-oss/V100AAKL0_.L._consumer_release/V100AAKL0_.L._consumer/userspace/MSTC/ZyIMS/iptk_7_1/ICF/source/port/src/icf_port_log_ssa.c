...
*  FUNCTION NAME  :   icf_port_log_ssa_error
...
icf_void_t icf_port_log_ssa_error(
...
*  FUNCTION NAME  :   icf_port_log_ssa_trace
...
icf_void_t icf_port_log_ssa_trace(
