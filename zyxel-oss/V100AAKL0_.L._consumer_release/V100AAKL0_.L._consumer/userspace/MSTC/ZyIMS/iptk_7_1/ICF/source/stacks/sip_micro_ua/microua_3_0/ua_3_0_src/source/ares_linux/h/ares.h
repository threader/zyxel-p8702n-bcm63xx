/* $Id: ares.h,v 1.3 2007/10/10 10:40:50 gur05066 Exp $ */
...
struct ares_options {
  ...
  // Enhanced code / Addition of new code
  // Indicates SSF running mode
  int IPNetworkType;
};
...
void free_query(void *ares_channel, int id);
void free_squery(void *arg);
