 ...
 *                                                version 4.2.3 
 * 19-Jan-2009 Sumit Manchanda     CSR 1-6792719  IPTK not compliable with PROTOS 
    ...
    OUT     icf_error_t                 *p_ecode)
{
	...
	{
		/*PANKAJ: Need to free codec list */
    ...
    OUT     icf_error_t                 *p_ecode)
{
	...
	ICF_MEMGET( p_glb_pdb,
		...
		else if(ICF_FAILURE ==  icf_cmn_add_node_to_list(p_glb_pdb,
					p_p_target_media_sdp_info,
					p_target_media_sdp))
		{
		    ret_val = ICF_FAILURE;
...
/*Fix For CSR 1-6792719 referred from SPR 19001*/
/*******************************************************************************
