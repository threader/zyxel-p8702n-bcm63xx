...
*  FUNCTION NAME  :   icf_port_log_twc_error
...
icf_void_t icf_port_log_twc_error(
...
*  FUNCTION NAME  :   icf_port_log_twc_trace
...
icf_void_t icf_port_log_twc_trace(
