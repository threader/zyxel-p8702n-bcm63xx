 ...
 ** 24-Jun-09  Rohit Aggarwal	SPR 19772	Replace host address strcpy with strncpy
 **
 **********************************************************************************
 **			Copyright 2005, Flextronics Software Systems, Ltd.
 **********************************************************************************/
#include "ALheader.h"
...
/*#SDF_LINT #else
		...
		else
        {
...
#endif /* SDF_TLS */
		    if(pDestInfo->pIp != Sdf_co_null)
			/* Fix for IPTK CSR 1-7423906: SPR 19772 */
			 ...
			 * larger than Sdf_co_characterBufferSize.
		 	 */
			/* UATK CSR 1-7432394 Change Start */
		             /*Sdf_mc_strcpy(dOldIp, pDestInfo->pIp);*/
			{
				Sdf_mc_strncpy(dOldIp, pDestInfo->pIp, (Sdf_co_characterBufferSize-1));
				dOldIp[Sdf_co_characterBufferSize-1]='\0';
			}
			/* UATK CSR 1-7432394 Change End */
...
#endif
			{
				 ...
				 */
				/* UATK CSR 1-7432394 Change Start */
				/* Sdf_mc_strcpy(dTempAddr, pHost); */
                Sdf_mc_strncpy(dTempAddr, pHost, (Sdf_co_characterBufferSize - 1));
				...
				if(pDestInfo->dPort == 0)
        {
								...
								SipAddrSipSUri))
          {
                                                                ...
                                                                Sdf_co_false)
			{
				...
				Sdf_mc_strcpy(pAppData->dOldIp, dOldIp);
				pAppData->pUrl = pUrl;
