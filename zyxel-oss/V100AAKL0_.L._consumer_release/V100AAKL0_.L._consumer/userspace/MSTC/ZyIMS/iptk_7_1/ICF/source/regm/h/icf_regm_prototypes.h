 ...
 *					The AUTH_SET bit is set for according to the scenario: IMS or NON IMS
 *                   
 * RETURNS:         ICF_SUCCESS: .       
 *					ICF_FAILURE: 
 ******************************************************************************/
 ...
 *					related data in rgm_context. For NON IMS only the nonce_count is made NULL
 *					as no Auth hdr sent. For IMS scenario, the 
 *					registrar on line data is used to set uri, realm and scheme
 *					is made as Digest.
 *                   
 * RETURNS:         ICF_SUCCESS: data initialized according to choice: IMS or non IMS
 *					ICF_FAILURE: system failure: line data fetching/ conversion of 
 ...
 * 
 * DESCRIPTION:     This function processes the non IMS authorization related
 ...
 *
 * DESCRIPTION:     This is a utility function that extracts the app_id from
