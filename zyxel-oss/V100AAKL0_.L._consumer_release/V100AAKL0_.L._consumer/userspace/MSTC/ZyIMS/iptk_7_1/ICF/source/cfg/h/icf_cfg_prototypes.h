...
#if 0
/****************************************************************************
 * FUNCTION:        icf_cfg_process_activate_resp
 *
 * DESCRIPTION:     This function is called by configuration module when
 *                  it receives response from network for a non-blocking 
 *                  activation request. CFG module passes response                    
 ...
 *
 ***************************************************************************/
icf_return_t icf_cfg_process_activate_resp(
        INOUT   icf_crm_pdb_st* p_crm_pdb);

/****************************************************************************
 * FUNCTION:        icf_cfg_process_deactivate_resp
 *
 * DESCRIPTION:     This function is called by configuration module when
 *                  it receives response from network for a non-blocking 
 *                  de-activation request. CFG module passes response                    
 *                  structure to this function. After that this function 
 *                  carries out the necessary processing.
 *
 * RETURNS:             
 *
 ***************************************************************************/
icf_return_t icf_cfg_process_deactivate_resp(
        INOUT   icf_crm_pdb_st* p_crm_pdb);
#endif
