...
#define ICF_SSA_HOLD_CLINE_ZERO      0x02
...
#define ICF_SSA_MAX_HEADER_VALUE_LEN ICF_SIP_MAX_HEADER_VALUE_LEN
/*
...
#define ICF_SSA_NUM_OF_EXTN_SUPP         (2)
...
#define ICF_DNS_TIMER_DIVISOR			10
