...
*  PURPOSE:
*
*     Logging implementation for call manager module.
*
*  NOTES:
*
****************************************************************************/
...
{                          
   ...
   if ( VODSL_LOG_DEBUG <= vodslGetLogLevel(VODSL_MODULE_CMGR) ) 
   {
...
{                          
   ...
   if ( VODSL_LOG_NOTICE <= vodslGetLogLevel(VODSL_MODULE_CMGR) ) 
   {
      va_start (varArgList, format);
      vodslPrint (format, varArgList);
      va_end (varArgList);
...
{                          
   ...
   if ( VODSL_LOG_ERROR <= vodslGetLogLevel(VODSL_MODULE_CMGR) ) 
   {
      va_start (varArgList, format);
      vodslPrint (format, varArgList);
      va_end (varArgList);
