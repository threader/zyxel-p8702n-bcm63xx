...
#define DNSROUTE_DOMAIN_NAME_LEN 128
#define DNSROUTE_SUBNETMASK_LEN 20
#define DNSROUTE_IFCNAME_LEN 32
#define DNSROUTE_GW_LEN 32
#define DNSROUTE_DNS_LEN 32
typedef struct DNSRoute_Entry_s{
	char domainName[DNSROUTE_DOMAIN_NAME_LEN];
	char subnetMask[DNSROUTE_SUBNETMASK_LEN];
	char ifcName[DNSROUTE_IFCNAME_LEN];
	char gateway[DNSROUTE_GW_LEN];
	char primary[DNSROUTE_DNS_LEN];
	char secondary[DNSROUTE_DNS_LEN];
}DNSRoute_Entry_t;
