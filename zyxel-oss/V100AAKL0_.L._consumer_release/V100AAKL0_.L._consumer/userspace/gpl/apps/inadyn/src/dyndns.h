...
#define FREEDNS_SYSTEM_DYNAMIC  "freedns"
#define NO_IP_SYSTEM_DYNAMIC  "no-ip" 
#define ZONEEDIT_SYSTEM_DYNAMIC  "zoneedit" 
...
#define FREEDNS_UPDATED  "Updated"
#define FREEDNS_ERROR  "ERROR"
