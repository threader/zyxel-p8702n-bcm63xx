 ...
 *
 * MDMOID_DEBUG_PORT_MIRROR_CFG 3
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_Q_MGMT_CLASSIFICATION 56
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_IP_INTF_FIREWALL_EXCEPTION 70
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DHCP_COND_SERV_OPTION 75
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
/*! \brief Obj struct for InternetGatewayDevice.LANDevice.{i}.X_5067F0_IPv6LANHostConfigManagement.X_5067F0_MldSnoopingConfig.
 *
 * MDMOID_MLD_SNOOPING_CFG 81
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_WLAN_ASSOCIATED_DEVICE_ENTRY 88
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_WLAN_PRE_SHARED_KEY 90
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_AP_WMM_PARAMETER_CFG 101
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_STA_WMM_PARAMETER_CFG 102
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_WLAN_WPS_REGISTRAR 112
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_MOCA_INTF_STATUS 114
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_MOCA_INTF_STATS 115
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_EPON_INTF_STATS 117
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_I_PV6_LAN_HOST_ENTRY 120
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_HOST_ICON_STATE 121
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_COMMON_INTF_CFG 123
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_XTM_INTERFACE_STATS 124
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_TOTAL 128
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_SHOWTIME 129
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_CURRENT_DAY 130
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_QUARTER_HOUR 131
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_TEST_PARAMS 132
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_MOCA_INTF_STATUS 137
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_MOCA_INTF_STATS 138
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_EPON_INTF_STATS 140
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L2TP_AC_INTF_CONFIG 141
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PON_INTF_STATUS 143
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_PROPRIETARY_DIAG 145
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_DIAG_NON_LINEARITY 147
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F4_END_TO_END_LOOPBACK_DIAG 149
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F4_LOOPBACK_DIAG 150
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F5_END_TO_END_LOOPBACK_DIAG 151
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM5_LOOPBACK_DIAG 156
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L2TP_AC_LINK_CONFIG 159
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WWAN_INTERFACE_CONFIG 160
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WWAN_INTERFACE_CONFIG_STATS 161
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WWAN_BUDGET_CONTROL 162
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_IP_CONN_PORTMAPPING 165
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_UPNP_IP_PORTMAPPING 166
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_IP_CONN_PORT_TRIGGERING 167
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_IP_CONN_FIREWALL_EXCEPTION 168
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IP_ETHERNET_WAN_MAC 172
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_PORTMAPPING 174
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_UPNP_PPP_PORTMAPPING 175
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_PORT_TRIGGERING 176
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_FIREWALL_EXCEPTION 177
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_PPP_ETHERNET_WAN_MAC 179
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_CONN_PORTMAPPING 180
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L3_FORWARDING_ENTRY 188
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_I_PV6_L3_FORWARDING 189
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_I_PV6_L3_FORWARDING_ENTRY 190
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_NEW_FLAG 202
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_NUMBER_OF_MISSED_CALLS 203
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_DATE_TIME 206
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CALL_LINE_NAME 207
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_INTERNAL_NAME_LIST 210
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_TERMINAL_NUMBER 211
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_INTERNAL_NAME 212
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_FIRST_NAME 215
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_NUMBER 216
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_MELODY 217
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_CONTACT_LINE_ID 218
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_SUPPORT_LIST 219
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_PROVIDER 225
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_SIP_SUBSCRIBE 227
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_RTP_SRTP 230
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_NUMBERING_PLAN 231
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_PROF_NUMBERING_PLAN_PREFIX_INFO 232
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_CALLING_FEATURES 236
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_PROCESSING 237
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_CODEC_LIST 239
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
/*! \brief Obj struct for InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.X_5067F0_LineSetting.
 *
 * MDMOID_VOICE_LINE_SETTING 242
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_DECT_LINE_ID 244
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_ATTACHED_HANDSET 245
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_DIALING_PREFIX 247
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_BLOCKED_NUMBER 249
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_MULTI_CALL_MODE 250
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_LINE_INTRUSION_CALL 251
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
/*! \brief Obj struct for InternetGatewayDevice.Services.VoiceService.{i}.VoiceProfile.{i}.Line.{i}.X_5067F0_DectLineSetting.CallForwarding.
 *
 * MDMOID_VOICE_LINE_CALL_FORWARDING 253
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_SYSTEM_SETTING 262
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_PIN_CODE 264
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_CLOCK_MASTER 265
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_RESET_BASE 266
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_FIRMWARE_VERSION 267
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_DECT_HARDWARE_VERSION 268
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ACCESS_TIME_RESTRICTION 277
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MSTC_MAC_FILTER_CFG 285
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DEBUG_PORT_MIRRORING_CFG 292
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAPI_AS_CERTIFICATE 296
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAPI_ISSUED_CERTIFICATE 297
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_EQUIPMENT_MANAGEMENT 313
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_PORT_MAPPING_PACKAGE_G 321
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_PORT_NETWORK_CTP 325
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_INTERWORKING_TP 326
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_GEM_INTERWORKING_TP 327
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_INTERWORKING_TP_MULTICAST_ADDRESS_TABLE 328
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_PORT_PM_HISTORY_DATA 329
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GAL_ETHERNET_PROFILE 330
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GAL_ETHERNET_PM_HISTORY_DATA 331
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_FEC_PM_HISTORY_DATA 332
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAYER2_DATA_SERVICES 333
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_SERVICE_PROFILE 334
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_MAC_BRIDGE_SERVICE_PROFILE 335
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_CONFIG_DATA 336
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PM_HISTORY_DATA 337
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_CONFIG_DATA 338
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_DESIGNATION_DATA 339
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_FILTER_TABLE_DATA 340
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_FILTER_PRE_ASSIGN_TABLE 342
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_BRIDGE_TABLE_DATA 343
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAC_BRIDGE_PORT_PM_HISTORY_DATA 345
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MAPPER_SERVICE_PROFILE 346
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_MAPPER_SERVICE_PROFILE 347
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VLAN_TAGGING_FILTER_DATA 348
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VLAN_TAGGING_OPERATION_CONFIGURATION_DATA 349
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_EXTENDED_VLAN_TAGGING_OPERATION_CONFIGURATION_DATA 350
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_RECEIVED_FRAME_VLAN_TAGGING_OPERATION_TABLE 351
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_OPERATIONS_PROFILE 352
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DYNAMIC_ACCESS_CONTROL_LIST_TABLE 353
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_STATIC_ACCESS_CONTROL_LIST_TABLE 354
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LOST_GROUPS_LIST_TABLE 355
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_SUBSCRIBER_CONFIG_INFO 356
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_SUBSCRIBER_MONITOR 357
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ACTIVE_GROUPS_LIST_TABLE 358
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_MULTICAST_SUBSCRIBER_MONITOR 359
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MULTICAST_SUBSCRIBER 360
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_UPSTREAM_ETHERNET_FRAME_PM_HISTORY_DATA 361
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DOWNSTREAM_ETHERNET_FRAME_PM_HISTORY_DATA 362
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAYER3_DATA_SERVICES 363
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IP_HOST_CONFIG_DATA 364
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_IP_HOST_CONFIG_DATA 365
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IP_HOST_PM_HISTORY_DATA 366
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_HOST_CONFIG_DATA 367
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_ADDRESS_TABLE 368
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_DEFAULT_ROUTER_TABLE 369
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_DNS_TABLE 370
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IPV6_CURRENT_ONLINK_PREFIX_TABLE 371
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_BC_IPV6_HOST_CONFIG_DATA 372
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TCP_UDP_CONFIG_DATA 373
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA 376
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA2 377
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ETHERNET_PM_HISTORY_DATA3 378
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VIRTUAL_ETHERNET_INTERFACE_POINT 379
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_AGENT_CONFIG_DATA 383
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VO_IP_MEDIA_PROFILE 385
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VO_IP_APP_SERVICE_PROFILE 388
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_VOICE_FEATURE_ACCESS_CODES 389
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_NETWORK_DIAL_PLAN_TABLE 390
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_CALL_CONTROL_PM_HISTORY_DATA 393
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_RTP_PM_HISTORY_DATA 394
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_AGENT_PM_HISTORY_DATA 395
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_SIP_CALL_INIT_PM_HISTORY_DATA 396
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MGC_PM_HISTORY_DATA 398
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_ETHERNET_PM_HISTORY_DATA 405
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_INTERFACE_PM_HISTORY_DATA 406
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MOCA_INTERFACE_PM_HISTORY_DATA_NODE_TABLE 407
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TRAFFIC_SCHEDULER_G 410
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GEM_TRAFFIC_DESCRIPTOR 411
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_AUTHENTICATION_SECURITY_METHOD 416
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_TR069_MANAGEMENT_SERVER 421
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_OAMSIP_USR_PARAM_CFG 433
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_OPTICAL_INTERFACE_STATS 446
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_MSTC_ACCESS_SERVICE 453
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
