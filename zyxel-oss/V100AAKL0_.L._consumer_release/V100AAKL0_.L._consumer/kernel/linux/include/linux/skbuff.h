...
#define CTF_HOTBRC_CMP(brc, da) ctf_hotbrc_cmp_fn(brc, da)
...
static inline int ctf_hotbrc_cmp_fn(ctf_brc_hot_t *brc, uint8_t *da)
{
	ctf_brc_hot_t *bh = brc + CTF_BRC_HOT_HASH(da); 
	ctf_brc_hot_t *bh2 = brc + CTF_BRC_HOT_HASH_2(da); 
    return (((_eacmp((bh)->ea.octet, (da)) == 0) && ((bh)->tx_dev)) || ((_eacmp((bh2)->ea.octet, (da)) == 0) && ((bh2)->tx_dev)));
}
