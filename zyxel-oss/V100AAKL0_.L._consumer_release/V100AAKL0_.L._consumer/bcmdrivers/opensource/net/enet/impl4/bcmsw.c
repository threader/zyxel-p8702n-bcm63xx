...
#endif
#if 1 //__MSTC__, DelonYu, merge patch from CSP#448131 and CSP#521898 for DSL-491GNU-B1D board
...
void ethsw_init_hw(int unit, uint32_t portMap,  int wanPortMap, int is6829)
{
  ...
  uint32 v32;
#endif
#if 1 //__MSTC__, DelonYu, merge patch from CSP#448131
	uint16 x16;//leo
#endif
...
#if 1 //__MSTC__, DelonYu, merge patch from CSP#448131 for DSL-491GNU-B1D C3 board
...
#endif
#if 1 //__MSTC__, DelonYu, Reset PHY on RGMII1 interface for HPNA bug CSP#522628
	x16 = 0x8000;
