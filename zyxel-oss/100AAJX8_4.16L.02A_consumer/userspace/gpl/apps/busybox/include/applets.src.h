...
IF_BRCTL(APPLET(brctl, _BB_DIR_SBIN, _BB_SUID_DROP))
...
IF_CHPASSWD(APPLET(chpasswd, _BB_DIR_SBIN, _BB_SUID_DROP))
...
IF_CROND(APPLET(crond, _BB_DIR_SBIN, _BB_SUID_DROP))
...
IF_DHCPRELAY(APPLET(dhcprelay, _BB_DIR_SBIN, _BB_SUID_DROP))
...
IF_DNSD(APPLET(dnsd, _BB_DIR_SBIN, _BB_SUID_REQUIRE))
...
IF_FAKEIDENTD(APPLET(fakeidentd, _BB_DIR_SBIN, _BB_SUID_DROP))
...
IF_FLASH_ERASEALL(APPLET(flash_eraseall, _BB_DIR_SBIN, _BB_SUID_DROP))
...
IF_HTTPD(APPLET(httpd, _BB_DIR_SBIN, _BB_SUID_DROP))
...
IF_TELNETD(APPLET(telnetd, _BB_DIR_SBIN, _BB_SUID_DROP))
...
IF_UDHCPD(APPLET(udhcpd, _BB_DIR_SBIN, _BB_SUID_DROP))
