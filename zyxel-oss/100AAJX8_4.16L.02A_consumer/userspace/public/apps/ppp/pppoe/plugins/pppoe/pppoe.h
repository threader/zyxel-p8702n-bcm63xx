...
/* brcm: added TAG_SRV_NAME2, TAG_SRV_NAME3, TAG_SRV_NAME4 to support up to 4 service name tags */
...
#define TAG_SRV_NAME2	9
#define TAG_SRV_NAME3	10
#define TAG_SRV_NAME4	11
#define TAG_EOL		   12    //9
...
//brcm extern struct pppoe_tag *get_tag(struct pppoe_hdr *ph, u_int16_t idx);
extern struct pppoe_tag *get_tag(struct pppoe_hdr *ph, u_int32_t idx);
...
extern void poe_dbglog __P((struct session *, char *, ...));	/* log a debug message */
extern void poe_info __P((struct session *, char *, ...));	/* log an informational message */
extern void poe_notice __P((struct session *, char *, ...));	/* log a notice-level message */
extern void poe_warn __P((struct session *, char *, ...));	/* log a warning message */
extern void poe_error __P((struct session *, char *, ...));	/* log an error message */
extern void poe_fatal __P((struct session *, char *, ...));	/* log an error message and die(1) */
