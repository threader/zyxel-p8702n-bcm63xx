...
#ifdef CONFIG_MSTC_MODIFY	/* The values of jiffies between "here" and "__nf_ct_refresh_acct" function are different,								so it will cause the variable "newtime" in "__nf_ct_refresh_acct" function overflow, MSTC Victor */
                        timeout = 3600 * HZ;
#else					
