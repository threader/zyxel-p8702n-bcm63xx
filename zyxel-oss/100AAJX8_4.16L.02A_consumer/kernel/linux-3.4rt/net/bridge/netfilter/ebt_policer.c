...
#ifdef CONFIG_MSTC_MODIFY //__MSTC__, Eric, Qos policer.
#include "skb_defines.h"
#define RED		1
#define YELLOW	2
#define GREEN 	3
#endif
#ifdef CONFIG_MSTC_MODIFY //__MSTC__, Jones For compilation
#define MODE_TBF   0
#define MODE_SRTCM 1
#define MODE_TRTCM 2
#endif
...
#ifdef CONFIG_MSTC_MODIFY //__MSTC__, Jones For compilation
static bool ebt_policer_match(const struct sk_buff *skb, struct xt_action_param *par)
