...
#ifdef CONFIG_CLASS_DOWNSTREAM_8021Q  //__MSTC__, FuChia,
	TCI = (unsigned short) skb->vtag_word;
	if((skb->vtag_word>>16) == 0 && TCI == 0)
	{
#endif
#ifdef CONFIG_MSTC_MODIFY //__MSTC__, FuChia,
...
#ifdef CONFIG_MSTC_MODIFY //__MSTC__, FuChia, QoS /*	ZyXEL, Wayne modified 2009/02/27 
	}else{
