...
#include <flash_api.h>
#if defined(CONFIG_MSTC_MODIFY) //__MSTC__, RaynorChung: Support 963268 nand flash, patch form SVN#3597 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11
...
{
#if defined(CONFIG_MSTC_MODIFY) //__MSTC__, Paul Ho: Support 963268 nand flash, patch form SVN#3781 on http://svn.zyxel.com.tw/svn/CPE_SW1/BCM96368/trunk/P-870HA/branches/cht/fttb8/4.11
	{name: "rootfs", offset: 0, size: 0},
	{name: "data",	 offset: 0, size: 0},
	{name: "nvram",  offset: 0, size: 0},
#ifdef CONFIG_SIK_PARTITION_FEATURE //__MSTC__, Marcus, add customer parttion to save SIK
    {name: "customer", offset: 0, size: 0},
#endif	
...
#if defined(CONFIG_MSTC_MODIFY) //__MSTC__, Dennis
...
#if defined(CONFIG_MSTC_MODIFY) //__MSTC__, Dennis, merge from Elina
...
#ifdef CONFIG_SIK_PARTITION_FEATURE //__MSTC__, Marcus, add customer parttion to save SIK
		bcm63XX_nand_parts[3].offset = ( nvram.ulNandPartOfsKb[NP_ROOTFS_2] - NAND_CUSTOMER_SIZE_KB ) * 1024;
		bcm63XX_nand_parts[3].size = NAND_CUSTOMER_SIZE_KB * 1024;
...
static int __init brcmnanddrv_init(void)
{
    ...
    if (flash_get_flash_type() != FLASH_IFC_NAND)
        return -ENODEV;
#if defined(CONFIG_MSTC_MODIFY) //__MSTC__
