...
#define BUZZZ_CYCLES_PER_USEC   (1000)
#define BUZZZ_KEVT_NANOSECS     (0) /* overhead subtracted per event */
#endif  /*  CONFIG_ARM */
...
/* Buzzz Character Device */
#define BUZZZ_NAME              "buzzz"

#define BUZZZ_DRV_MAJOR         253 /* see targets/makeDevs */
#define BUZZZ_DRV_MINOR         0
#define BUZZZ_DRV_NAME          BUZZZ_NAME
#define BUZZZ_DRV_DEVICE_NAME   "/dev/" BUZZZ_DRV_NAME
...
typedef enum buzzz_ioctl {
	/* On ARM, safe to start IOCTL values from after 100 */

	BUZZZ_IOCTL_DUMMY = 99,

	BUZZZ_IOCTL_KCALL,
	BUZZZ_IOCTL_CONFIG_TOOL,
	BUZZZ_IOCTL_CONFIG_MODE,
	BUZZZ_IOCTL_CONFIG_LIMIT,
	BUZZZ_IOCTL_CONFIG_FUNC,
	BUZZZ_IOCTL_CONFIG_PMON,
	BUZZZ_IOCTL_CONFIG_KEVT,
	BUZZZ_IOCTL_SHOW,
	BUZZZ_IOCTL_START,
	BUZZZ_IOCTL_STOP,
	BUZZZ_IOCTL_PAUSE,
