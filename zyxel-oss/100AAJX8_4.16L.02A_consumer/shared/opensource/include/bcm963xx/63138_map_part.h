...
typedef struct I2s {
	uint32 cfg;		/* 0x00 */
	uint32 ddrFifoAddr;	/* 0x04 */
	uint32 ddrFifoDepth;	/* 0x08 */
	uint32 ddrFifoRptr;	/* 0x0c */
} I2s;
...
#if defined(CONFIG_BCM963138) && !defined(CONFIG_BRCM_CHIP_VER_A0) /* 63138B0 onwards 5x3 crossbar */
