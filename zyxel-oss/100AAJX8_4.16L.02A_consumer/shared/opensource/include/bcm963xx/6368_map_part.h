...
#ifndef __BCM6368_MAP_PART_H
#define __BCM6368_MAP_PART_H

#ifdef __cplusplus
extern "C" {
#endif

#define CHIP_FAMILY_ID_HEX	0x6368
...
#define SWITCH_CMF_BASE      (SWITCH_BASE + 0x0000a000)  /* Switch CMF register base */
