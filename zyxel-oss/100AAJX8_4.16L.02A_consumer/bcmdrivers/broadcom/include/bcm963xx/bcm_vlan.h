...
typedef enum {
    ...
    BCM_VLAN_OPCODE_POP_AND_SAVE_TAG,
    BCM_VLAN_OPCODE_SET_QOS_OR_DEFAULT_VID,
    BCM_VLAN_OPCODE_SET_QOS_OR_DEFAULT_PBITS,
    BCM_VLAN_OPCODE_PUSH_QOS_OR_DEFAULT_TAG,
    BCM_VLAN_OPCODE_MSTC_QOS_VLAN_PROCESS,
