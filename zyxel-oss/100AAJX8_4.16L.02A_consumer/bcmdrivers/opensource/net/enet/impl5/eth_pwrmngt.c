...
int ethsw_shutdown_unused_phys(void)
{
    ...
    for (i = 0; i < NUM_INT_EPHYS; i++) {
        if ((portmap & (1U<<i)) == 0) {
            ...
            MISC_REG->EphyPwrMgnt |= EPHY_PWR_DOWN_ALL_1 >> (i*EPHY_PWR_DOWN_SHIFT_FACTOR);
...
#elif defined(CONFIG_BCM96318) || defined(CONFIG_BCM963381)
    {
        uint16 v16;
...
static void ethsw_eee_all_enable(int enable)
{
#if defined(GPHY_EEE_1000BASE_T_DEF) || defined(CONFIG_BCM_EXT_SWITCH) || defined(CONFIG_BCM96318) || defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148) || defined(CONFIG_BCM963381)
   struct net_device *dev = vnet_dev[0];
   BcmEnet_devctrl *priv = (BcmEnet_devctrl *)netdev_priv(dev);
   int i;
   int phys_port;
