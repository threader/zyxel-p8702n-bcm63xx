...
#ifdef MSTC_MODIFY //__MSTC__, DelonYu, merge patch from CSP#448131 and CSP#521898 for DSL-491GNU-B1D board
...
int bcmsw_dump_mib_ext(int port, int type)
{
    ...
    extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXUPKTS, &v32, 4);  // Get TX unicast packet count
    printk("TxUnicastPkts:          %10u \n", v32);
    extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXMPKTS, &v32, 4);  // Get TX multicast packet count
    printk("TxMulticastPkts:        %10u \n",  v32);
    extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXBPKTS, &v32, 4);  // Get TX broadcast packet count
    printk("TxBroadcastPkts:        %10u \n", v32);
    extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXDROPS, &v32, 4);
    printk("TxDropPkts:             %10u \n", v32);

    if (type) 
    {
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXOCTETS, data, DATA_TYPE_MIB_COUNT|8);
        v32 = (((uint32*)data)[0]);                                
        printk("TxOctetsLo:             %10u \n", v32);
        v32 = (((uint32*)data)[1]);                                
        printk("TxOctetsHi:             %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXQ0PKT, &v32, 4);
        printk("TxQ0Pkts:               %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXCOL, &v32, 4);
        printk("TxCol:                  %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXSINGLECOL, &v32, 4);
        printk("TxSingleCol:            %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXMULTICOL, &v32, 4);
        printk("TxMultipleCol:          %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXDEFERREDTX, &v32, 4);
        printk("TxDeferredTx:           %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXLATECOL, &v32, 4);
        printk("TxLateCol:              %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXEXCESSCOL, &v32, 4);
        printk("TxExcessiveCol:         %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXFRAMEINDISC, &v32, 4);
        printk("TxFrameInDisc:          %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXPAUSEPKTS, &v32, 4);
        printk("TxPausePkts:            %10u \n", v32);
    }
    /* Display Rx statistics */
    extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXUPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);  // Get RX unicast packet count
    printk("RxUnicastPkts:          %10u \n", v32);
    extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXMPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);  // Get RX multicast packet count
    printk("RxMulticastPkts:        %10u \n",v32);
    extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXBPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);  // Get RX broadcast packet count
    printk("RxBroadcastPkts:        %10u \n",v32);
    extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXDROPS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
    printk("RxDropPkts:             %10u \n",v32); 
    extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXDISCARD_EXT, &v32, 4);
    printk("RxDiscard:              %10u \n", v32);
   
    if (type) 
    {
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXJABBERS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxJabbers:              %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXALIGNERRORS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxAlignErrs:            %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXFCSERRORS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxFCSErrs:              %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXFRAGMENTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxFragments:            %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXOVERSIZE + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxOversizePkts:         %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXOUTOFRANGE_EXT, &v32, 4);
        printk("RxOutOfRange:           %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXUNDERSIZEPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxUndersizePkts:        %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXPAUSEPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxPausePkts:            %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXSACHANGES + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxSAChanges:            %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXSYMBOLERRORS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxSymbolError:          %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RX64OCTPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxPkts64Octets:         %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RX127OCTPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxPkts65to127Octets:    %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RX255OCTPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxPkts128to255Octets:   %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RX511OCTPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxPkts256to511Octets:   %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RX1023OCTPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxPkts512to1023Octets:  %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXMAXOCTPKTS + REG_MIB_P0_EXTSWITCH_OFFSET, &v32, 4);
        printk("RxPkts1024OrMoreOctets: %10u \n", v32);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXJUMBOPKT_EXT , &v32, 4);
...
int bcmsw_get_hw_stats(int port, int extswitch, struct net_device_stats *stats)
{
    ...
    if (extswitch) {
        ...
        // Track RX byte count
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXOCTETS + REG_MIB_P0_EXTSWITCH_OFFSET, data, DATA_TYPE_MIB_COUNT|8);
        stats->rx_bytes = (unsigned long )(*(uint32 *)&data[0]); /* Truncate 4-MSByte */
        
        // Track RX packet errors
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXDROPS + REG_MIB_P0_EXTSWITCH_OFFSET, data, 4);
        stats->rx_dropped = (*(uint32 *)data);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXFCSERRORS + REG_MIB_P0_EXTSWITCH_OFFSET, data, 4);
        stats->rx_errors = (*(uint32 *)data);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXSYMBOLERRORS + REG_MIB_P0_EXTSWITCH_OFFSET, data, 4);
        stats->rx_errors += (*(uint32 *)data);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_RXALIGNERRORS + REG_MIB_P0_EXTSWITCH_OFFSET, data, 4);
        stats->rx_errors += (*(uint32 *)data);

        // Track TX unicast, multicast, and broadcast packets
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXUPKTS, data, 4);  // Get TX unicast packet count
        ctr64 = (*(uint32 *)data);                                // Keep running count

        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXMPKTS, data, 4);  // Get TX multicast packet count
        stats->tx_multicast_packets = (*(uint32 *)data);                        // Save away count
        ctr64 += (*(uint32 *)data);                                             // Keep running count

        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXBPKTS, data, 4);  // Get TX broadcast packet count
        ...
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXDROPS, data, 4);
        stats->tx_dropped = (*(uint32 *)data);
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), REG_MIB_P0_TXFRAMEINDISC, data, 4);
        stats->tx_dropped += (*(uint32 *)data);
    } else
    {
...
{
    extsw_wreg_wrap(PAGE_PORT_BASED_VLAN, REG_VLAN_CTRL_P0 + (port * 2), (uint8_t *)&portMap, sizeof(portMap));
}
...
//
    ...
    if (type) 
    {
        ...
        printk("RxPkts1024OrMoreOctets: %10u \n", v32);
#if 0
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), SF2_REG_MIB_P0_RXJUMBOPKT_EXT , &v32, 4);
        printk("RxJumboPkts:            %10u \n", v32);
#endif
        extsw_rreg_wrap(PAGE_MIB_P0 + (port), SF2_REG_MIB_P0_RXOUTRANGEERR, &v32, 4);
        printk("RxOutOfRange:           %10u \n", v32);
...
void sf2_rgmii_config(void)
{
    ...
    for (unit=0; unit < BP_MAX_ENET_MACS; unit++) 
    {
        ...
        for(phy_port = 0; phy_port < BCMENET_MAX_PHY_PORTS; phy_port++)
        {
            ...
            val32 |= SF2_ENABLE_PORT_RGMII_INTF | SF2_TX_ID_DIS; 
...
int sf2_cos_priority_method_config(struct ethswctl_data *e)
{
    ...
    if (e->type == TYPE_GET) {
        ...
        if (e->pkt_type_mask == SF2_QOS_TC_SRC_SEL_PKT_TYPE_ALL)
        {
            ...
            {
                printk("%s port %d pkt_type_mask 0x%x tc src = 0x%x \n", __FUNCTION__,
                        e->port, i, (val16 >> (i * 2)) & SF2_QOS_TC_SRC_SEL_VAL_MASK);
            }
        } else {
            pkt_type_mask &=  SF2_QOS_TC_SRC_SEL_PKT_TYPE_MASK;
            val16 =  (val16 >> (pkt_type_mask * 2)) & SF2_QOS_TC_SRC_SEL_VAL_MASK;
            printk("port %d pkt_type_mask 0x%x tc src = 0x%x \n",
                    e->port, pkt_type_mask, val16); 
        }
        ...
        reg_addr = SF2_REG_PORTN_TC_SELECT_TABLE + e->port * 2;
        tc_sel_src = e->val;
        val16 = tc_sel_src = ~tc_sel_src; 
        // when pkt_type_mask is is SF2_QOS_TC_SRC_SEL_PKT_TYPE_ALL, 
        // tc_sel_src is a 16 bit string of TC selection for all packet types.
        if (e->pkt_type_mask != SF2_QOS_TC_SRC_SEL_PKT_TYPE_ALL)
        {
            extsw_rreg_wrap(PAGE_QOS, reg_addr, &val16, 2);
            pkt_type_mask = e->pkt_type_mask & SF2_QOS_TC_SRC_SEL_PKT_TYPE_MASK;
            val16 &= ~(SF2_QOS_TC_SRC_SEL_VAL_MASK << (pkt_type_mask * 2));
            val16 |=  (tc_sel_src & SF2_QOS_TC_SRC_SEL_VAL_MASK )
                                 << (pkt_type_mask * 2);
        }
        extsw_wreg_wrap(PAGE_QOS, reg_addr, &val16, 2);
        BCM_ENET_DEBUG("%s: Write to: len %d page 0x%x reg 0x%x val 0x%x\n",
                __FUNCTION__,
                2, PAGE_QOS, reg_addr, val16);
        if (e->val == MAC_QOS) {
            // Disable DSCP for the port
            extsw_rreg_wrap(PAGE_QOS, REG_QOS_DSCP_EN, (void *)&val16, 2);
            val16 &= ~(1 << e->port);
            extsw_wreg_wrap(PAGE_QOS, REG_QOS_DSCP_EN, (void *)&val16, 2);
            // Disable PCP for the port
            ...
            val16 &= ~(1 << e->port);
            extsw_wreg_wrap(PAGE_QOS, REG_QOS_DSCP_EN, (void *)&val16, 2);
            // Enable PCP for the port
            extsw_rreg_wrap(PAGE_QOS, REG_QOS_8021P_EN, (void *)&val16, 2);
            val16 |= 1 << e->port;
            extsw_wreg_wrap(PAGE_QOS, REG_QOS_8021P_EN, (void *)&val16, 2);
        } else if (e->val == DIFFSERV_QOS) {
            // Enable DSCP for the port
            extsw_rreg_wrap(PAGE_QOS, REG_QOS_DSCP_EN, (void *)&val16, 2);
            val16 |= 1 << e->port;
            extsw_wreg_wrap(PAGE_QOS, REG_QOS_DSCP_EN, (void *)&val16, 2);
            // Disable PCP for the port
