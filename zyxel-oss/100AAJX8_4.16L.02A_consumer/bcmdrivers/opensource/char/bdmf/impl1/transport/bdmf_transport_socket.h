...
/*******************************************************************
 * bdmf_transport_domain_socket.h
 *
 * Inter-subsystem communication
 * Domain socket-based transport service
 *
 ...
 *******************************************************************/
#ifndef _BL_TRANSPORT_SOCKET_H_
#define _BL_TRANSPORT_SOCKET_H_


struct bdmfts_socket_msg
{
    struct bdmfts_tmsg tmsg;           /**< Transport-independent header */
    int msg_idx;
};

int bdmfts_socket_init(void);

#endif /* _BL_TRANSPORT_SOCKET_H_ */
