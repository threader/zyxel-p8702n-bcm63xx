...
#ifdef BDMF_RPC
    BDMF_ERR_RMT_NO_RESOURCES = -30,  /**< Delivery failure. No resources reported by the remote side */
    BDMF_ERR_RMT_MSG_ERROR    = -31,  /**< Remote side detected error in message encoding */
    BDMF_ERR_RPC_AREA_FULL    = -32,  /**< RPC parameters area is full */
    BDMF_ERR_RPC_DECODE_ERROR = -33,  /**< Error when decoding RPC field */
    BDMF_ERR_RPC_SIZE_ERROR   = -34,  /**< Unexpected RPC field size */
    BDMF_ERR_RPC_NO_SERVER    = -35,  /**< No RPC server that can handle a message */
    BDMF_ERR_RPC_MSG_ERROR    = -36,  /**< Error in RPC message encoding */
    BDMF_ERR_RPC_FUNC         = -37,  /**< RPC function is not supported */
    BDMF_ERR_RPC_NO_OBJ       = -38,  /**< Remote object is not found */
#endif
