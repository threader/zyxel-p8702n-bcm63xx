...
#ifdef BDMF_RPC
        [-BDMF_ERR_RMT_NO_RESOURCES] = "Delivery failure. No resources reported by the remote side",
        [-BDMF_ERR_RMT_MSG_ERROR] = "Remote side detected error in message encoding",
        [-BDMF_ERR_RPC_AREA_FULL] = "RPC parameters area is full",
        [-BDMF_ERR_RPC_DECODE_ERROR] = "Error when decoding RPC field",
        [-BDMF_ERR_RPC_SIZE_ERROR] = "Unexpected RPC field size",
        [-BDMF_ERR_RPC_NO_SERVER] = "No RPC server that can handle a message",
        [-BDMF_ERR_RPC_MSG_ERROR] = "Error in RPC message encoding",
        [-BDMF_ERR_RPC_FUNC]      = "RPC function is not supported",
        [-BDMF_ERR_RPC_NO_OBJ]    = "Remote object is not found",
#endif
    };
    err = -err;
