...
typedef enum {
    ...
    rdpa_ingress_class_attr_cfg = 2, /* cfg : MRI : aggregate/24 class_configuration(rdpa_ic_cfg_t ) : Ingress class configuration */
    rdpa_ingress_class_attr_nflow = 3, /* nflow : R : number/4 : Number of associated classification flows */
    rdpa_ingress_class_attr_flow = 4, /* flow : RWADF : aggregate/144[255] class_info(rdpa_ic_info_t ) : Ingress class flow entry */
