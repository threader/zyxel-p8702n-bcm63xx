 ...
 */
int rdpa_cpu_wfd_bulk_fkb_get(bdmf_index queue_id, unsigned int budget,
                              void ** rx_pkts, void * rdpa_cpu_data_p);
 ...
 * \return Number of received packets\n
*/
int rdpa_cpu_wfd_bulk_skb_get(bdmf_index queue_id, unsigned int budget,
                              void ** rx_pkts, void * rdpa_cpu_data_p);
...
/** Send system buffer to Ethernet WAN Interface
 *
 * \param[in]   sysb          System buffer. Released regardless on the function outcome
