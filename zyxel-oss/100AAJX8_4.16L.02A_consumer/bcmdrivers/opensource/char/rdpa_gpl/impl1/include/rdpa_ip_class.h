...
typedef enum
{
	RDPA_IP_CLASS_MASK_PURE_MAC = ( 1 << RDPA_IP_CLASS_PURE_MAC ),  /**< In this mode pure mac packests are redirected in Ingress Classification flow */
	RDPA_IP_CLASS_MASK_MC_IP    = ( 1 << RDPA_IP_CLASS_MC_IP ),     /**< In this mode packests with multicast destination IP are redirected in Ingress Classification flow */
	RDPA_IP_CLASS_MASK_PURE_IP  = ( 1 << RDPA_IP_CLASS_PURE_IP ),   /**< In this mode pure IP packests are redirected in Ingress Classification flow */
	RDPA_IP_CLASS_MASK_US_WLAN  = ( 1 << RDPA_IP_CLASS_US_WLAN ),   /**< In this mode packets from lan to wlan will not pass through flow cache */
