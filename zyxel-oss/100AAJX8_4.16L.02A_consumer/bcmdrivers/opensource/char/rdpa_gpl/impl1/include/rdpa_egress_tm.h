...
typedef unsigned char (*EponGlobalShaperFunc) (uint32_t);
extern EponGlobalShaperFunc global_shaper_cb;

/*call back pointer to register epon stack link rate limter funtion*/
typedef unsigned char (*EponLinkShaperFunc) (uint8_t, uint32_t, uint16_t);
extern EponLinkShaperFunc epon_link_shaper_cb;
