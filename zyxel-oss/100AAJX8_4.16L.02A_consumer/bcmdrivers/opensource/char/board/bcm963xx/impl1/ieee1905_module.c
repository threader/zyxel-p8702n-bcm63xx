...
static void _i5ModulePushButtonNotify( unsigned long timeInMs, unsigned long param )
{
      ...
      case I5_UDP_CMD_PUSH_BUTTON_REGISTER:
        {
          ...
          if ( 0 == pMsg->reg ) {
            deregisterPushButtonPressNotifyHook(PB_BUTTON_1, _i5ModulePushButtonNotify);
          }
          else {
            registerPushButtonPressNotifyHook(PB_BUTTON_1, _i5ModulePushButtonNotify, 0);
          }
          break;
        }
