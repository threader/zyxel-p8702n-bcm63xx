...
#if defined(CONFIG_BCM96816) || defined(CHIP_6816) || defined(CONFIG_BCM96818) || defined(CHIP_6818) || defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148) || defined(CHIP_63138) || defined(CHIP_63148)
...
#endif
#else
#if (defined(CONFIG_BCM96816) || defined(CONFIG_BCM96818)) || (defined(CHIP_6816) || defined(CHIP_6818)) || (defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148)) || (defined(CHIP_63138) || defined(CHIP_63148)) 
#define NUM_EGRESS_QUEUES  8
#else
#define NUM_EGRESS_QUEUES  4
#endif
