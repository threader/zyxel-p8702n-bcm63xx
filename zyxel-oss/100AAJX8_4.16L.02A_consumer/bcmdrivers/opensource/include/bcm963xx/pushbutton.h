...
typedef void (* pushButtonNotifyHook_t)(unsigned long timeInMs, unsigned long param);
...
extern int registerPushButtonPressNotifyHook(PB_BUTTON_ID btn, pushButtonNotifyHook_t hook, unsigned long param);
extern int registerPushButtonHoldNotifyHook(PB_BUTTON_ID btn, pushButtonNotifyHook_t hook, unsigned long timeInMs, unsigned long param);
extern int registerPushButtonReleaseNotifyHook(PB_BUTTON_ID btn, pushButtonNotifyHook_t hook, unsigned long timeInMs, unsigned long param);
